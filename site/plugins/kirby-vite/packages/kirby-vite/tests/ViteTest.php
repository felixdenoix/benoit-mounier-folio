...
it("generates JS for production", function () {
    ...
    $result = "<script src=\"/dist/assets/main.1234.js\" type=\"module\"></script>";
    expect($this->vite->js("main.js"))->toBe($result);

    $result = "<script data-test=\"test\" defer src=\"/dist/assets/main.1234.js\" type=\"module\"></script>";
...
it("omits errors for missing JS entries when trying in production", function () {
    setMode("production");
...
it("omits CSS imported by JS in development", function () {
    ...
    expect($this->vite->css("main.css"))->toBe('<link href="http://localhost:5173/main.css" rel="stylesheet">');
});
...
it("generates CSS for production", function () {
    ...
    $result = "<link data-test=\"test\" href=\"/dist/assets/main.1234.css\" media=\"print\" rel=\"stylesheet\">";
...
it("provides a file path for development", function () {
    setMode("development");
    expect($this->vite->file("my-font.woff2"))->toBe("http://localhost:5173/my-font.woff2");
});

it("provides a file path for production", function () {
    setMode("production");
    expect($this->vite->file("my-font.woff2"))->toBe("/dist/assets/my-font.1234.woff2");
});
...
it("generates panel assets in development", function () {
    ...
    expect($this->vite->panelJs("main.js"))->toBe(["@vite/client", "http://localhost:5173/main.js"]);
    expect($this->vite->panelCss("main.js"))->toBe(null);
    expect($this->vite->panelCss("main.css"))->toBe(["http://localhost:5173/main.css"]);
});
