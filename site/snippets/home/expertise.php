        ...
        <?php foreach ($ctaItems as $index => $item): ?>
            <a
                ...
                <span
                    ...
                    ><?= $item["label"] ?></span>
                <div
                    class="hidden pointer-events-none absolute bottom-0 left-0 w-full h-[33svh] md:grid grid-cols-1 grid-rows-1 place-items-stretch min-w-0 min-h-0 opacity-0 scale-99 transition duration-500 ease-projects group-hover/link:opacity-100 group-hover/link:scale-101 group-focus/link:opacity-100 group-focus/link:scale-101"
