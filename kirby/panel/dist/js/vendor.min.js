...
function n(e, t, r) {
  for (let i = 0; ; i++) {
    if (i == e.childCount || i == t.childCount) return e.childCount == t.childCount ? null : r;
    let o = e.child(i),
      s = t.child(i);
    if (o != s) {
      if (!o.sameMarkup(s)) return r;
      if (o.isText && o.text != s.text) {
        for (let e = 0; o.text[e] == s.text[e]; e++) r++;
        return r;
      }
      if (o.content.size || s.content.size) {
        let e = n(o.content, s.content, r + 1);
        if (null != e) return e;
      }
      r += o.nodeSize;
    } else r += o.nodeSize;
...
function r(e, t, n, i) {
  for (let o = e.childCount, s = t.childCount; ; ) {
    if (0 == o || 0 == s) return o == s ? null : { a: n, b: i };
    let l = e.child(--o),
      a = t.child(--s),
      h = l.nodeSize;
    if (l != a) {
      if (!l.sameMarkup(a)) return { a: n, b: i };
      if (l.isText && l.text != a.text) {
        let e = 0,
          t = Math.min(l.text.length, a.text.length);
        for (; e < t && l.text[l.text.length - e - 1] == a.text[a.text.length - e - 1]; ) (e++, n--, i--);
        return { a: n, b: i };
      }
      if (l.content.size || a.content.size) {
        let e = r(l.content, a.content, n - 1, i - 1);
        if (e) return e;
      }
      ((n -= h), (i -= h));
    } else ((n -= h), (i -= h));
...
class i {
  ...
  nodesBetween(e, t, n, r = 0, i) {
    for (let o = 0, s = 0; s < t; o++) {
      ...
      if (a > e && !1 !== n(l, r + s, i || null, o) && l.content.size) {
        let i = s + 1;
        l.nodesBetween(Math.max(0, e - i), Math.min(l.content.size, t - i), n, r + i);
      }
      s = a;
    }
  }
  ...
  append(e) {
    ...
    let t = this.lastChild,
      ...
      o = 0;
    for (
      t.isText && t.sameMarkup(n) && ((r[r.length - 1] = t.withText(t.text + n.text)), (o = 1));
      o < e.content.length;
      o++
    )
      r.push(e.content[o]);
        ...
        (l > e &&
          ((o < e || l > t) &&
            (s = s.isText
              ...
              : s.cut(Math.max(0, e - o - 1), Math.min(s.content.size, t - o - 1))),
          n.push(s),
          (r += s.nodeSize)),
          (o = l));
      }
  ...
  cutByIndex(e, t) {
    return e == t ? i.empty : 0 == e && t == this.content.length ? this : new i(this.content.slice(e, t));
  }
  replaceChild(e, t) {
  ...
  findIndex(e) {
    ...
    for (let t = 0, n = 0; ; t++) {
      ...
      if (r >= e) return r == e ? s(t + 1, r) : s(t, n);
      n = r;
    }
  }
  toString() {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      ((n += i.nodeSize),
        r && i.isText && e[r - 1].sameMarkup(i)
          ? (t || (t = e.slice(0, r)), (t[t.length - 1] = i.withText(t[t.length - 1].text + i.text)))
          : t && t.push(i));
    }
    return new i(t || e, n);
  }
...
class a {
  ...
  static setFrom(e) {
    if (!e || (Array.isArray(e) && 0 == e.length)) return a.none;
...
class c {
  ...
  insertAt(e, t) {
    let n = p(this.content, e + this.openStart, t);
    return n && new c(n, this.openStart, this.openEnd);
  }
  removeBetween(e, t) {
    return new c(d(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  eq(e) {
  ...
  static fromJSON(e, t) {
    ...
    return new c(i.fromJSON(e, t.content), n, r);
  }
...
function w(e, t, n, r) {
  ...
  e && ((o = e.index(n)), e.depth > n ? o++ : e.textOffset && (y(e.nodeAfter, r), o++));
  for (let l = o; l < s; l++) y(i.child(l), r);
...
function x(e, t, n, r, o) {
  let s = e.depth > o && g(e, t, o + 1),
    l = r.depth > o && g(n, r, o + 1),
    a = [];
  return (
    w(null, e, o, a),
    s && l && t.index(o) == n.index(o)
      ? (m(s, l), y(v(s, x(e, t, n, r, o + 1)), a))
      : (s && y(v(s, b(e, t, o + 1)), a), w(t, n, o, a), l && y(v(l, b(n, r, o + 1)), a)),
    w(r, null, o, a),
    new i(a)
  );
}
function b(e, t, n) {
  let r = [];
  if ((w(null, e, n, r), e.depth > n)) {
    y(v(g(e, t, n + 1), b(e, t, n + 1)), r);
  }
  return (w(t, null, n, r), new i(r));
}
c.empty = new c(i.empty, 0, 0);
class S {
  constructor(e, t, n) {
  ...
  posAtIndex(e, t) {
    ...
    for (let i = 0; i < e; i++) r += n.child(i).nodeSize;
    return r;
  }
  marks() {
    let e = this.parent,
      t = this.index();
    if (0 == e.content.size) return a.none;
    ...
    for (var o = 0; o < i.length; o++)
      !1 !== i[o].type.spec.inclusive || (r && i[o].isInSet(r.marks)) || (i = i[o--].removeFromSet(i));
    return i;
  }
  marksAcross(e) {
    ...
    for (var i = 0; i < n.length; i++)
      !1 !== n[i].type.spec.inclusive || (r && n[i].isInSet(r.marks)) || (n = n[i--].removeFromSet(n));
    return n;
  }
  sharedDepth(e) {
  ...
  blockRange(e = this, t) {
    ...
    for (let n = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0); n >= 0; n--)
      if (e.pos <= this.end(n) && (!t || t(this.node(n)))) return new O(this, e, n);
    return null;
  }
  sameParent(e) {
  ...
  static resolve(e, t) {
    ...
    let n = [],
      ...
      i = t;
    for (let o = e; ; ) {
      let { index: e, offset: t } = o.content.findIndex(i),
        s = i - t;
  ...
  static resolveCached(e, t) {
    ...
    else C.set(e, (n = new k()));
    let r = (n.elts[n.i] = S.resolve(e, t));
    return ((n.i = (n.i + 1) % M), r);
  }
}
class k {
  constructor() {
...
class T {
  constructor(e, t, n, r = a.none) {
    ((this.type = e), (this.attrs = t), (this.marks = r), (this.content = n || i.empty));
  }
  get children() {
  ...
  hasMarkup(e, t, n) {
    return this.type == e && l(this.attrs, t || e.defaultAttrs || N) && a.sameSet(this.marks, n || a.none);
  }
  copy(e = null) {
  ...
  replace(e, t, n) {
    return u(this.resolve(e), this.resolve(t), n);
  }
  nodeAt(e) {
    for (let t = this; ; ) {
  ...
  canReplace(e, t, n = i.empty, r = 0, o = n.childCount) {
    ...
    for (let i = r; i < o; i++) if (!this.type.allowsMarks(n.child(i).marks)) return !1;
    return !0;
  }
  ...
  static parse(e, t) {
    ...
    let i = (function (e) {
      ...
      function n(r) {
        ...
        let o = (t[r.join(",")] = new A(r.indexOf(e.length - 1) > -1));
      ...
      e
        .map((t, n) => {
          ...
          for (let i = 0; i < t.next.length; i++)
            r += (i ? ", " : "") + t.next[i].type.name + "->" + e.indexOf(t.next[i].next);
          return r;
        })
        .join("\n")
    );
...
function J(e, t, n, r) {
  for (let i in t) if (!(i in e)) throw new RangeError(`Unsupported attribute ${i} for ${n} of type ${i}`);
  for (let i in e) {
    let n = e[i];
    n.validate && n.validate(t[i]);
  }
}
function q(e, t) {
  let n = Object.create(null);
  if (t) for (let r in t) n[r] = new _(e, r, t[r]);
  return n;
}
let j = class e {
  constructor(e, t, n) {
    ((this.name = e),
      ...
      (this.attrs = q(e, n.attrs)),
      (this.defaultAttrs = L(this.attrs)),
  ...
  create(e = null, t, n) {
    ...
    return new T(this, this.computeAttrs(e), i.from(t), a.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return ((t = i.from(t)), this.checkContent(t), new T(this, this.computeAttrs(e), t, a.setFrom(n)));
  }
  createAndFill(e = null, t, n) {
    ...
    return o ? new T(this, e, t.append(o), a.setFrom(n)) : null;
  }
  validContent(e) {
  ...
  static compile(t, n) {
    ...
    for (let e in r.text.attrs) throw new RangeError("The text node type should not have attributes");
    return r;
  }
};
class _ {
        ...
        "string" == typeof n.validate
          ? (function (e, t, n) {
              ...
              return (n) => {
                ...
                if (r.indexOf(i) < 0)
                  throw new RangeError(`Expected value of type ${r} for attribute ${t} on type ${e}, got ${i}`);
              };
            })(e, t, n.validate)
          : n.validate));
  }
...
class K {
  constructor(e, t, n, r) {
    ((this.name = e),
      ...
      (this.schema = n),
      (this.spec = r),
      (this.attrs = q(e, r.attrs)),
      (this.excluded = null));
    let i = L(this.attrs);
    this.instance = i ? new a(this, i) : null;
  }
  create(e = null) {
    return !e && this.instance ? this.instance : new a(this, W(this.attrs, e));
  }
  static compile(e, t) {
    let n = Object.create(null),
      r = 0;
...
class H {
  constructor(e) {
    ...
    ((n.nodes = t.from(e.nodes)),
      (n.marks = t.from(e.marks || {})),
    ...
    for (let t in this.nodes) {
      ...
      let e = this.nodes[t],
        ...
        i = e.spec.marks;
      if (
        ((e.contentMatch = r[n] || (r[n] = A.parse(n, this.nodes))),
      ...
      e.markSet = "_" == i ? null : i ? Y(this, i.split(" ")) : "" != i && e.inlineContent ? null : [];
    }
    for (let t in this.marks) {
      let e = this.marks[t],
        n = e.spec.excludes;
      e.excluded = null == n ? [e] : "" == n ? [] : Y(this, n.split(" "));
    }
    ((this.nodeFromJSON = (e) => T.fromJSON(this, e)),
      (this.markFromJSON = (e) => a.fromJSON(this, e)),
  ...
  node(e, t = null, n, r) {
    if ("string" == typeof e) e = this.nodeType(e);
      ...
      if (!(e instanceof j)) throw new RangeError("Invalid node type: " + e);
  ...
  text(e, t) {
    ...
    return new D(n, n.defaultAttrs, e, a.setFrom(t));
  }
  mark(e, t) {
...
class U {
  ...
  parse(e, t = {}) {
    let n = new te(this, t, !1);
    return (n.addAll(e, a.none, t.from, t.to), n.finish());
  }
  parseSlice(e, t = {}) {
    let n = new te(this, t, !0);
    return (n.addAll(e, a.none, t.from, t.to), c.maxOpen(n.finish()));
  }
  matchTag(e, t, n) {
    ...
    for (let i = r ? this.styles.indexOf(r) + 1 : 0; i < this.styles.length; i++) {
      ...
      if (
        !(
          ...
          (o.length > e.length && (61 != o.charCodeAt(e.length) || o.slice(e.length + 1) != t))
        )
      ) {
        if (r.getAttrs) {
          let e = r.getAttrs(t);
  ...
  static schemaRules(e) {
    ...
    for (let r in e.marks) {
      ...
      t &&
        t.forEach((e) => {
          (n((e = re(e))), e.mark || e.ignore || e.clearMark || (e.mark = r));
        });
    }
    for (let r in e.nodes) {
      ...
      t &&
        t.forEach((e) => {
          (n((e = re(e))), e.node || e.ignore || e.mark || (e.node = r));
        });
    }
    return t;
  }
  static fromSchema(e) {
    return e.cached.domParser || (e.cached.domParser = new U(e, U.schemaRules(e)));
  }
}
const G = {
    address: !0,
  ...
  Z = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  X = { ol: !0, ul: !0 };
function Q(e, t, n) {
...
class ee {
  constructor(e, t, n, r, i, o) {
    ((this.type = e),
      ...
      (this.match = i || (4 & o ? null : e.contentMatch)));
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type) return [];
  ...
  finish(e) {
    ...
    return (
      !e && this.match && (t = t.append(this.match.fillBefore(i.empty, !0))),
  ...
  inlineContext(e) {
    return this.type
      ...
      : this.content.length
        ...
        : e.parentNode && !G.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class te {
  constructor(e, t, n) {
    ...
    let r,
      i = t.topNode,
      o = Q(null, t.preserveWhitespace, 0) | (n ? 4 : 0);
    ((r = i
      ? new ee(i.type, i.attrs, a.none, !0, t.topMatch || i.type.contentMatch, o)
      : new ee(n ? null : e.schema.topNodeType, null, a.none, !0, null, o)),
      (this.nodes = [r]),
      ...
      if (i)
        if ("full" === i) n = n.replace(/\r\n?/g, "\n");
          ...
          for (let n = 0; n < e.length; n++)
            (n && this.insertNode(o.linebreakReplacement.create(), t, !0),
              e[n] && this.insertNode(o.text(e[n]), t, !/\S/.test(e[n])));
          n = "";
        } else n = n.replace(/\r?\n|\r/g, " ");
      else if (
    ...
    X.hasOwnProperty(s) &&
      ...
      (function (e) {
        for (let t = e.firstChild, n = null; t; t = t.nextSibling) {
          ...
          e && X.hasOwnProperty(e) && n ? (n.appendChild(t), (t = n)) : "li" == e ? (n = t) : e && (n = null);
        }
      })(e);
    let l = (this.options.ruleFromNode && this.options.ruleFromNode(e)) || (o = this.parser.matchTag(e, this, n));
    e: if (l ? l.ignore : Z.hasOwnProperty(s)) (this.findInside(e), this.ignoreFallback(e, t));
      ...
      let o = l && l.skip ? t : this.readStyles(e, t);
      (o && this.addAll(e, o), n && this.sync(i), (this.needsBlock = r));
    } else {
      let n = this.readStyles(e, t);
      n && this.addElementByRule(e, l, n, !1 === l.consuming ? o : void 0);
    }
    ...
    if (n && n.length)
      for (let r = 0; r < this.parser.matchedStyles.length; r++) {
        let e = this.parser.matchedStyles[r],
          i = n.getPropertyValue(e);
        if (i)
          for (let n; ; ) {
            let r = this.parser.matchStyle(e, i, this, n);
            if (!r) break;
            if (r.ignore) return null;
            if (
              ((t = r.clearMark
                ? t.filter((e) => !r.clearMark(e))
                : t.concat(this.parser.schema.marks[r.mark].create(r.attrs))),
              !1 !== r.consuming)
            )
              break;
            n = r;
  ...
  addElementByRule(e, t, n, r) {
    ...
    if (t.node)
      if (((o = this.parser.schema.nodes[t.node]), o.isLeaf))
        this.insertNode(o.create(t.attrs), n, "BR" == e.nodeName) || this.leafFallback(e, n);
      else {
        let e = this.enter(o, t.attrs || null, n, t.preserveWhitespace);
        e && ((i = !0), (n = e));
      }
    else {
    ...
    if (o && o.isLeaf) this.findInside(e);
      ...
      (this.findInside(e), t.getContent(e, this.parser.schema).forEach((e) => this.insertNode(e, n, !1)));
    else {
      let r = e;
  ...
  addAll(e, t, n, r) {
    let i = n || 0;
    for (
      let o = n ? e.childNodes[n] : e.firstChild, s = null == r ? null : e.childNodes[r];
      o != s;
      o = o.nextSibling, ++i
    )
  ...
  findPlace(e, t, n) {
    ...
    for (let o = this.open, s = 0; o >= 0; o--) {
      let t = this.nodes[o],
        l = t.findWrapping(e);
      if (l && (!r || r.length > l.length + s) && ((r = l), (i = t), !l.length)) break;
      if (t.solid) {
        if (n) break;
        s += 2;
      }
  ...
  insertNode(e, t, n) {
    ...
    if (r) {
      ...
      for (let i of r.concat(e.marks))
        (t.type ? t.type.allowsMarkType(i.type) : ie(i.type, e.type)) && (n = i.addToSet(n));
  ...
  enterInner(e, t, n, r = !1, i) {
    ...
    let s = Q(e, i, o.options);
    4 & o.options && 0 == o.content.length && (s |= 4);
    let l = a.none;
    return (
      (n = n.filter((t) => !(o.type ? o.type.allowsMarkType(t.type) : ie(t.type, e)) || ((l = t.addToSet(l)), !1))),
      this.nodes.push(new ee(e, t, l, r, null, s)),
      this.open++,
      n
    );
  }
    ...
    let t = e.split("/"),
      ...
      o = (e, s) => {
        for (; e >= 0; e--) {
          ...
          {
            let e = s > 0 || (0 == s && r) ? this.nodes[s].type : n && s >= i ? n.node(s - i).type : null;
            if (!e || (e.name != l && !e.isInGroup(l))) return !1;
            s--;
          }
        }
        return !0;
...
class oe {
  ...
  serializeNodeInner(e, t) {
    let { dom: n, contentDOM: r } = ce(le(t), this.nodes[e.type.name](e), null, e.attrs);
    if (r) {
  ...
  serializeMark(e, t, n = {}) {
    ...
    return r && ce(le(n), r(e, t), null, e.attrs);
  }
  ...
  static fromSchema(e) {
    return (
      e.cached.domSerializer || (e.cached.domSerializer = new oe(this.nodesFromSchema(e), this.marksFromSchema(e)))
    );
  }
...
function ce(e, t, n, r) {
  ...
  let a = n ? e.createElementNS(n, o) : e.createElement(o),
    h = t[1],
    c = 1;
  if (h && "object" == typeof h && null == h.nodeType && !Array.isArray(h)) {
    c = 2;
    for (let e in h)
      if (null != h[e]) {
        let t = e.indexOf(" ");
        t > 0
          ? a.setAttributeNS(e.slice(0, t), e.slice(t + 1), h[e])
          : "style" == e && a.style
            ? (a.style.cssText = h[e])
            : a.setAttribute(e, h[e]);
      }
  }
  for (let d = c; d < t.length; d++) {
    let i = t[d];
    if (0 === i) {
      if (d < t.length - 1 || d > c) throw new RangeError("Content hole must be the only child of its parent node");
      return { dom: a, contentDOM: a };
    }
    {
      let { dom: t, contentDOM: o } = ce(e, i, n, r);
      if ((a.appendChild(t), o)) {
...
class me {
  ...
  recover(e) {
    let t = 0,
      n = ue(e);
    if (!this.inverted) for (let r = 0; r < n; r++) t += this.ranges[3 * r + 2] - this.ranges[3 * r + 1];
    return (
      this.ranges[3 * n] +
      t +
      (function (e) {
  ...
  _map(e, t, n) {
    ...
    for (let s = 0; s < this.ranges.length; s += 3) {
      ...
      let a = this.ranges[s + i],
        ...
        c = l + a;
      if (e <= c) {
        let i = l + r + ((a ? (e == l ? -1 : e == c ? 1 : t) : t) < 0 ? 0 : h);
        if (n) return i;
        let o = e == (t < 0 ? l : c) ? null : pe(s / 3, e - l),
          d = e == l ? 2 : e == c ? 1 : 4;
        return ((t < 0 ? e != l : e != c) && (d |= 8), new fe(i, d, o));
      }
      r += h - a;
    }
    return n ? e + r : new fe(e + r, 0, null);
  }
  touches(e, t) {
    let n = 0,
      r = ue(t),
  ...
  static offset(e) {
    return 0 == e ? me.empty : new me(e < 0 ? [0, -e, 0] : [0, 0, e]);
  }
}
me.empty = new me([]);
class ge {
  ...
  slice(e = 0, t = this.maps.length) {
    return new ge(this.maps, this.mirror, e, t);
  }
  copy() {
    return new ge(this.maps.slice(), this.mirror && this.mirror.slice(), this.from, this.to);
  }
  appendMap(e, t) {
...
class we {
  ...
  static jsonID(e, t) {
    if (e in ye) throw new RangeError("Duplicate use of step JSON ID " + e);
...
class ve {
  ...
  static fromReplace(e, t, n, r) {
    try {
      return ve.ok(e.replace(t, n, r));
    } catch (i) {
      if (i instanceof h) return ve.fail(i.message);
      throw i;
    }
  }
}
function xe(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let o = e.child(i);
    (o.content.size && (o = o.copy(xe(o.content, t, o))), o.isInline && (o = t(o, n, i)), r.push(o));
  }
...
class be extends we {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      ...
      i = new c(
        xe(
          t.content,
          (e, t) => (e.isAtom && t.type.allowsMarkType(this.mark.type) ? e.mark(this.mark.addToSet(e.marks)) : e),
          r,
        ),
        t.openStart,
        t.openEnd,
      );
    return ve.fromReplace(e, this.from, this.to, i);
  }
  invert() {
  ...
  merge(e) {
    return e instanceof be && e.mark.eq(this.mark) && this.from <= e.to && this.to >= e.from
...
class Se extends we {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new c(
        xe(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e),
        t.openStart,
        t.openEnd,
      );
    return ve.fromReplace(e, this.from, this.to, n);
  }
  invert() {
  ...
  merge(e) {
    return e instanceof Se && e.mark.eq(this.mark) && this.from <= e.to && this.to >= e.from
      ? new Se(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
      : null;
  }
  toJSON() {
...
class ke extends we {
  ...
  apply(e) {
    ...
    if (!t) return ve.fail("No node at mark step's position");
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return ve.fromReplace(e, this.pos, this.pos + 1, new c(i.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
      ...
      if (e.length == t.marks.length) {
        for (let n = 0; n < t.marks.length; n++) if (!t.marks[n].isInSet(e)) return new ke(this.pos, t.marks[n]);
...
class Me extends we {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return t && this.mark.isInSet(t.marks) ? new ke(this.pos, this.mark) : this;
  }
  map(e) {
    let t = e.mapResult(this.pos, 1);
...
we.jsonID("removeNodeMark", Me);
class Ce extends we {
  constructor(e, t, n, r = !1) {
    (super(), (this.from = e), (this.to = t), (this.slice = n), (this.structure = r));
  }
  apply(e) {
    return this.structure && Ne(e, this.from, this.to)
      ? ve.fail("Structure replace would overwrite content")
      : ve.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    let t = e.mapResult(this.from, 1),
      n = e.mapResult(this.to, -1);
    return t.deletedAcross && n.deletedAcross ? null : new Ce(t.pos, Math.max(t.pos, n.pos), this.slice);
  }
  merge(e) {
      ...
      if (e.to != this.from || this.slice.openStart || e.slice.openEnd) return null;
      {
        let t =
          this.slice.size + e.slice.size == 0
            ? c.empty
            : new c(e.slice.content.append(this.slice.content), e.slice.openStart, this.slice.openEnd);
    ...
    }
    {
      let t =
        this.slice.size + e.slice.size == 0
          ? c.empty
          : new c(this.slice.content.append(e.slice.content), this.slice.openStart, e.slice.openEnd);
...
class Oe extends we {
  ...
  apply(e) {
    if (this.structure && (Ne(e, this.from, this.gapFrom) || Ne(e, this.gapTo, this.to)))
      return ve.fail("Structure gap-replace would overwrite content");
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return ve.fail("Gap is not a flat range");
    let n = this.slice.insertAt(this.insert, t.content);
    return n ? ve.fromReplace(e, this.from, this.to, n) : ve.fail("Content does not fit in gap");
  }
  getMap() {
    return new me([
      this.from,
  ...
  map(e) {
    ...
    return (t.deletedAcross && n.deletedAcross) || r < t.pos || i > n.pos
      ? null
      : new Oe(t.pos, n.pos, r, i, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
...
function Te(e, t, n, r = n.contentMatch, o = !0) {
  ...
  for (let h = 0; h < s.childCount; h++) {
    let t = s.child(h),
      d = a + t.nodeSize,
      p = r.matchType(t.type);
    if (p) {
      r = p;
      for (let r = 0; r < t.marks.length; r++) n.allowsMarkType(t.marks[r].type) || e.step(new Se(a, d, t.marks[r]));
      if (o && t.isText && "pre" != n.whitespace) {
        let e,
          r,
          o = /\r?\n|\r/g;
        for (; (e = o.exec(t.text)); )
          (r || (r = new c(i.from(n.schema.text(" ", n.allowedMarks(t.marks))), 0, 0)),
            l.push(new Ce(a + e.index, a + e.index + e[0].length, r)));
      }
    } else l.push(new Ce(a, d, c.empty));
    a = d;
  }
  if (!r.validEnd) {
    let t = r.fillBefore(i.empty, !0);
    e.replace(a, a, new c(t, 0, 0));
  }
  for (let i = l.length - 1; i >= 0; i--) e.step(l[i]);
}
function De(e, t, n) {
...
function Ee(e) {
  ...
  for (let n = e.depth; ; --n) {
    ...
    if (0 == n || r.type.spec.isolating || !De(r, i, o)) break;
  }
  return null;
}
  ...
  let i = (function (e, t) {
    ...
    o =
      ...
      (function (e, t) {
        ...
        for (let a = r; l && a < i; a++) l = l.matchType(n.child(a).type);
        return l && l.validEnd ? s : null;
      })(r, t);
  return o ? i.map($e).concat({ type: t, attrs: n }).concat(o.map($e)) : null;
}
function $e(e) {
  ...
  t.forEach((i, o) => {
    if (i.isText) {
      let s,
        l = /\r?\n|\r/g;
      for (; (s = l.exec(i.text)); ) {
        let i = e.mapping.slice(r).map(n + 1 + o + s.index);
...
function ze(e, t, n = 1, r) {
  ...
  if (
    ...
    return !1;
  for (let h = i.depth - 1, c = n - 2; h > o; h--, c--) {
    let e = i.node(h),
      t = i.index(h);
    ...
    let s = (r && r[c]) || e;
    if (!e.canReplace(t + 1, e.childCount) || !s.type.validContent(n)) return !1;
  }
    ...
    !(
      ...
      !(function (e, t) {
        ...
        for (let i = 0; i < t.childCount; i++) {
          let o = t.child(i),
            s = o.type == r ? e.type.schema.nodes.text : o.type;
          if (((n = n.matchType(s)), !n)) return !1;
          if (!e.type.allowsMarks(o.marks)) return !1;
        }
        return n.validEnd;
      })(i, o)
...
function Be(e, t, n = t, r = c.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    o = e.resolve(n);
  return Ve(i, o, r) ? new Ce(t, n, r) : new Fe(i, o, r).fit();
}
function Ve(e, t, n) {
  return !n.openStart && !n.openEnd && e.start() == t.start() && e.parent.canReplace(e.index(), t.index(), n.content);
}
we.jsonID("replaceAround", Oe);
class Fe {
  constructor(e, t, n) {
    ((this.$from = e), (this.$to = t), (this.unplaced = n), (this.frontier = []), (this.placed = i.empty));
    for (let r = 0; r <= e.depth; r++) {
      let t = e.node(r);
      this.frontier.push({ type: t.type, match: t.contentMatchAt(e.indexAfter(r)) });
    }
    for (let r = e.depth; r > 0; r--) this.placed = i.from(e.node(r).copy(this.placed));
  }
  get depth() {
  ...
  fit() {
    ...
    let l = new c(i, o, s);
    return e > -1
      ? new Oe(n.pos, e, this.$to.pos, this.$to.end(), l, t)
      : l.size || n.pos != this.$to.pos
        ? new Ce(n.pos, r.pos, l)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = 1 == t ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n ? ((r = Je(this.unplaced.content, n - 1).firstChild), (e = r.content)) : (e = this.unplaced.content);
        let o = e.firstChild;
        for (let s = this.depth; s >= 0; s--) {
          ...
          if (
            1 == t &&
            (o ? a.matchType(o.type) || (h = a.fillBefore(i.from(o), !1)) : r && l.compatibleContent(r.type))
          )
            return { sliceDepth: n, frontierDepth: s, parent: r, inject: h };
          if (2 == t && o && (e = a.findWrapping(o.type)))
            return { sliceDepth: n, frontierDepth: s, parent: r, wrap: e };
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
      r = Je(e, t);
    return (
      !(!r.childCount || r.firstChild.isLeaf) &&
      ((this.unplaced = new c(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0))), !0)
    );
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new c(Le(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new c(Le(e, t, 1), t, n);
  }
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: o }) {
    for (; this.depth > t; ) this.closeFrontierNode();
    if (o) for (let i = 0; i < o.length; i++) this.openFrontierNode(o[i]);
    let s = this.unplaced,
    ...
    if (r) {
      for (let e = 0; e < r.childCount; e++) d.push(r.child(e));
      p = p.matchFragment(r);
    }
    ...
    for (; h < l.childCount; ) {
      ...
      (h++,
        (h > 1 || 0 == a || e.content.size) &&
          ((p = t), d.push(qe(e.mark(u.allowedMarks(e.marks)), 1 == h ? a : 0, h == l.childCount ? f : -1))));
    }
    let m = h == l.childCount;
    (m || (f = -1),
      (this.placed = We(this.placed, t, i.from(d))),
    ...
    for (let i = 0, c = l; i < f; i++) {
      let e = c.lastChild;
      (this.frontier.push({ type: e.type, match: e.contentMatchAt(e.childCount) }), (c = e.content));
    }
    this.unplaced = m
      ? 0 == e
        ? c.empty
        : new c(Le(s.content, e - 1, 1), e - 1, f < 0 ? s.openEnd : e - 1)
      : new c(Le(s.content, e, h), s.openStart, s.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !t.type.isTextblock ||
      !je(this.$to, this.$to.depth, t.type, t.match, !1) ||
  ...
  close(e) {
    ...
    (t.fit.childCount && (this.placed = We(this.placed, t.depth, t.fit)), (e = t.move));
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = We(this.placed, this.depth, i.from(e.create(t, n)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let e = this.frontier.pop().match.fillBefore(i.empty, !0);
    e.childCount && (this.placed = We(this.placed, this.frontier.length, e));
  }
}
function Le(e, t, n) {
  return 0 == t
    ? e.cutByIndex(n, e.childCount)
    : e.replaceChild(0, e.firstChild.copy(Le(e.firstChild.content, t - 1, n)));
}
function We(e, t, n) {
  return 0 == t ? e.append(n) : e.replaceChild(e.childCount - 1, e.lastChild.copy(We(e.lastChild.content, t - 1, n)));
}
function Je(e, t) {
...
function qe(e, t, n) {
  ...
  let r = e.content;
  return (
    t > 1 && (r = r.replaceChild(0, qe(r.firstChild, t - 1, 1 == r.childCount ? n - 1 : 0))),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(i.empty, !0)))),
    e.copy(r)
  );
}
...
function Ke(e, t, n, r, o) {
  if (t < n) {
    let i = e.firstChild;
    e = e.replaceChild(0, i.copy(Ke(i.content, t + 1, n, r, i)));
  }
  if (t > r) {
    let t = o.contentMatchAt(0),
      n = t.fillBefore(e).append(e);
    e = n.append(t.matchFragment(n).fillBefore(i.empty, !0));
  }
  return e;
}
function He(e, t) {
...
class Ye extends we {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return ve.fail("No node at attribute step's position");
    let n = Object.create(null);
    for (let i in t.attrs) n[i] = t.attrs[i];
    n[this.attr] = this.value;
    let r = t.type.create(n, null, t.marks);
    return ve.fromReplace(e, this.pos, this.pos + 1, new c(i.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return me.empty;
  }
...
we.jsonID("docAttr", Ue);
let Ge = class extends Error {};
((Ge = function e(t) {
  let n = Error.call(this, t);
  return ((n.__proto__ = e.prototype), n);
}),
  ((Ge.prototype = Object.create(Error.prototype)).constructor = Ge),
  (Ge.prototype.name = "TransformError"));
class Ze {
  constructor(e) {
    ((this.doc = e), (this.steps = []), (this.docs = []), (this.mapping = new ge()));
  }
  get before() {
  ...
  replace(e, t = e, n = c.empty) {
    let r = Be(this.doc, e, t, n);
    return (r && this.step(r), this);
  }
  replaceWith(e, t, n) {
    return this.replace(e, t, new c(i.from(n), 0, 0));
  }
  delete(e, t) {
    ...
    return (
      (function (e, t, n, r) {
        ...
        let i = e.doc.resolve(t),
          o = e.doc.resolve(n);
        if (Ve(i, o, r)) return e.step(new Ce(t, n, r));
        let s = He(i, e.doc.resolve(n));
        0 == s[s.length - 1] && s.pop();
        let l = -(i.depth + 1);
        s.unshift(l);
        for (let c = i.depth, u = i.pos - 1; c > 0; c--, u--) {
          let e = i.node(c).type.spec;
          if (e.defining || e.definingAsContext || e.isolating) break;
          s.indexOf(c) > -1 ? (l = c) : i.before(c) == u && s.splice(1, 0, -c);
        }
        let a = s.indexOf(l),
          h = [],
          d = r.openStart;
        for (let c = r.content, u = 0; ; u++) {
          let e = c.firstChild;
          if ((h.push(e), u == r.openStart)) break;
          c = e.content;
        }
        for (let c = d - 1; c >= 0; c--) {
          let e = h[c],
            t = _e(e.type);
          if (t && !e.sameMarkup(i.node(Math.abs(l) - 1))) d = c;
          else if (t || !e.type.isTextblock) break;
        }
        for (let u = r.openStart; u >= 0; u--) {
          let t = (u + d + 1) % (r.openStart + 1),
            l = h[t];
          if (l)
            for (let h = 0; h < s.length; h++) {
              let d = s[(h + a) % s.length],
                p = !0;
              d < 0 && ((p = !1), (d = -d));
              let u = i.node(d - 1),
                f = i.index(d - 1);
              if (u.canReplaceWith(f, f, l.type, l.marks))
                return e.replace(
                  i.before(d),
                  p ? o.after(d) : n,
                  new c(Ke(r.content, 0, r.openStart, t), t, r.openEnd),
                );
            }
        }
        let p = e.steps.length;
        for (let c = s.length - 1; c >= 0 && (e.replace(t, n, r), !(e.steps.length > p)); c--) {
          let e = s[c];
          ...
          let i = (function (e, t, n) {
            ...
            if (0 == r.parentOffset)
              for (let i = r.depth - 1; i >= 0; i--) {
                let e = r.index(i);
                if (r.node(i).canReplaceWith(e, e, n)) return r.before(i + 1);
                if (e > 0) return null;
              }
            if (r.parentOffset == r.parent.content.size)
              for (let i = r.depth - 1; i >= 0; i--) {
                let e = r.indexAfter(i);
                if (r.node(i).canReplaceWith(e, e, n)) return r.after(i + 1);
                if (e < r.node(i).childCount) return null;
              }
            return null;
          })(e.doc, t, r.type);
          null != i && (t = n = i);
        }
        e.replaceRange(t, n, new c(i.from(r), 0, 0));
      })(this, e, t, n),
      this
    );
  }
    ...
    return (
      (function (e, t, n) {
        ...
        for (let s = 0; s < o.length; s++) {
          let t = o[s],
            n = s == o.length - 1;
          if ((n && 0 == t) || r.node(t).type.contentMatch.validEnd) return e.delete(r.start(t), i.end(t));
          if (t > 0 && (n || r.node(t - 1).canReplace(r.index(t - 1), i.indexAfter(t - 1))))
            return e.delete(r.before(t), i.after(t));
        }
    ...
    return (
      (function (e, t, n) {
        let { $from: r, $to: o, depth: s } = t,
          ...
          p = i.empty,
          u = 0;
        for (let c = s, g = !1; c > n; c--)
          g || r.index(c) > 0 ? ((g = !0), (p = i.from(r.node(c).copy(p))), u++) : h--;
        let f = i.empty,
          m = 0;
        for (let c = s, g = !1; c > n; c--)
          g || o.after(c + 1) < o.end(c) ? ((g = !0), (f = i.from(o.node(c).copy(f))), m++) : d++;
        e.step(new Oe(h, d, l, a, new c(p.append(f), u, m), p.size - u, !0));
      })(this, e, t),
      this
    );
  }
    ...
    return (
      (function (e, t, n) {
        ...
        if (!1 === r) {
          ...
          Ie(e, r.node(), r.before(), l);
        }
        s.inlineContent && Te(e, t + n - 1, s, o.node().contentMatchAt(o.index()), null == r);
        let a = e.mapping.slice(l),
          h = a.map(t - n);
        if ((e.step(new Ce(h, a.map(t + n, -1), c.empty, !0)), !0 === r)) {
          let t = e.doc.resolve(h);
          Re(e, t.node(), t.before(), e.steps.length);
        }
      })(this, e, t),
      this
    );
    ...
    return (
      (function (e, t, n) {
        ...
        for (let l = n.length - 1; l >= 0; l--) {
          if (r.size) {
            let e = n[l].type.contentMatch.matchFragment(r);
            if (!e || !e.validEnd)
              throw new RangeError(
                "Wrapper type given to Transform.wrap does not form valid content of its parent wrapper",
              );
          }
          r = i.from(n[l].type.create(n[l].attrs, r));
        }
        let o = t.start,
          s = t.end;
        e.step(new Oe(o, s, o, s, new c(r, 0, 0), n.length, !0));
      })(this, e, t),
      this
    );
  }
      ...
      (function (e, t, n, r, o) {
        ...
        e.doc.nodesBetween(t, n, (t, n) => {
          ...
          if (
            ...
            })(e.doc, e.mapping.slice(s).map(n), r)
          ) {
            let o = null;
            ...
            (!1 === o && Ie(e, t, n, s), Te(e, e.mapping.slice(s).map(n, 1), r, void 0, null === o));
            let a = e.mapping.slice(s),
              h = a.map(n, 1),
              d = a.map(n + t.nodeSize, 1);
            return (
              e.step(new Oe(h, d, h + 1, d - 1, new c(i.from(r.create(l, null, t.marks)), 0, 0), 1, !0)),
              !0 === o && Re(e, t, n, s),
              !1
            );
          }
  ...
  setNodeMarkup(e, t, n = null, r) {
    return (
      (function (e, t, n, r, o) {
        ...
        n || (n = s.type);
        let l = n.create(r, null, o || s.marks);
        ...
        e.step(new Oe(t, t + s.nodeSize, t + 1, t + s.nodeSize - 1, new c(i.from(l), 0, 0), 1, !0));
      })(this, e, t, n, r),
      this
    );
  }
  setNodeAttribute(e, t, n) {
    return (this.step(new Ye(e, t, n)), this);
  }
  setDocAttribute(e, t) {
    ...
    return (
      (function (e, t, n = 1, r) {
        let o = e.doc.resolve(t),
          s = i.empty,
          l = i.empty;
        for (let a = o.depth, h = o.depth - n, c = n - 1; a > h; a--, c--) {
          s = i.from(o.node(a).copy(s));
          let e = r && r[c];
          l = i.from(e ? e.type.create(e.attrs, l) : o.node(a).copy(l));
        }
        e.step(new Ce(t, t, new c(s.append(l), n, n), !0));
      })(this, e, t, n),
      this
    );
  }
        ...
        (e.doc.nodesBetween(t, n, (e, a, h) => {
          ...
          if (!r.isInSet(c) && h.type.allowsMarkType(r.type)) {
            ...
            for (let e = 0; e < c.length; e++)
              c[e].isInSet(p) || (i && i.to == h && i.mark.eq(c[e]) ? (i.to = d) : s.push((i = new Se(h, d, c[e]))));
            o && o.to == h ? (o.to = d) : l.push((o = new be(h, d, r)));
          }
        }),
      ...
      (function (e, t, n, r) {
        ...
        (e.doc.nodesBetween(t, n, (e, s) => {
          ...
          if (r instanceof K) {
            let t,
              n = e.marks;
            for (; (t = r.isInSet(n)); ) ((l || (l = [])).push(t), (n = t.removeFromSet(n)));
          } else r ? r.isInSet(e.marks) && (l = [r]) : (l = e.marks);
          if (l && l.length) {
            ...
            for (let e = 0; e < l.length; e++) {
              ...
              n ? ((n.to = r), (n.step = o)) : i.push({ style: a, from: Math.max(s, t), to: r, step: o });
            }
          }
        }),
          i.forEach((t) => e.step(new Se(t.from, t.to, t.style))));
      })(this, e, t, n),
      this
    );
  }
...
class Qe {
  ...
  replace(e, t = c.empty) {
    let n = t.content.lastChild,
      r = null;
    for (let s = 0; s < t.openEnd; s++) ((r = n), (n = n.lastChild));
    let i = e.steps.length,
      o = this.ranges;
    for (let s = 0; s < o.length; s++) {
      let { $from: l, $to: a } = o[s],
        h = e.mapping.slice(i);
      (e.replaceRange(h.map(l.pos), h.map(a.pos), s ? c.empty : t),
        0 == s && ct(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1));
    }
  }
  replaceWith(e, t) {
    ...
    for (let i = 0; i < r.length; i++) {
      let { $from: o, $to: s } = r[i],
        ...
        a = l.map(o.pos),
        h = l.map(s.pos);
      i ? e.deleteRange(a, h) : (e.replaceRangeWith(a, h, t), ct(e, n, t.isInline ? -1 : 1));
    }
  }
  static findFrom(e, t, n = !1) {
    let r = e.parent.inlineContent ? new rt(e) : ht(e.node(0), e.parent, e.pos, e.index(), t, n);
    if (r) return r;
    for (let i = e.depth - 1; i >= 0; i--) {
      let r =
        t < 0
          ? ht(e.node(0), e.node(i), e.before(i + 1), e.index(i), t, n)
          : ht(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, t, n);
      if (r) return r;
    }
    return null;
  }
  static near(e, t = 1) {
    return this.findFrom(e, t) || this.findFrom(e, -t) || new lt(e.node(0));
  }
  static atStart(e) {
    return ht(e, e, 0, 0, 1) || new lt(e);
  }
  static atEnd(e) {
    return ht(e, e, e.content.size, e.childCount, -1) || new lt(e);
  }
  static fromJSON(e, t) {
  ...
  static jsonID(e, t) {
    if (e in Xe) throw new RangeError("Duplicate use of selection JSON ID " + e);
    return ((Xe[e] = t), (t.prototype.jsonID = e), t);
  }
  getBookmark() {
...
class rt extends Qe {
  ...
  map(e, t) {
    ...
    if (!n.parent.inlineContent) return Qe.near(n);
    let r = e.resolve(t.map(this.anchor));
    return new rt(r.parent.inlineContent ? r : n, n);
  }
  replace(e, t = c.empty) {
  ...
  eq(e) {
    return e instanceof rt && e.anchor == this.anchor && e.head == this.head;
  }
  getBookmark() {
  ...
  static fromJSON(e, t) {
    ...
    return new rt(e.resolve(t.anchor), e.resolve(t.head));
  }
  ...
  static between(e, t, n) {
    ...
    if (((n && !r) || (n = r >= 0 ? 1 : -1), !t.parent.inlineContent)) {
      let e = Qe.findFrom(t, n, !0) || Qe.findFrom(t, -n, !0);
      if (!e) return Qe.near(t, n);
      t = e.$head;
    }
    return (
      e.parent.inlineContent ||
        ((0 == r || (e = (Qe.findFrom(e, -n, !0) || Qe.findFrom(e, n, !0)).$anchor).pos < t.pos != r < 0) && (e = t)),
      new rt(e, t)
    );
  }
}
...
class it {
  ...
  resolve(e) {
    return rt.between(e.resolve(this.anchor), e.resolve(this.head));
  }
}
class ot extends Qe {
  constructor(e) {
  ...
  map(e, t) {
    let { deleted: n, pos: r } = t.mapResult(this.anchor),
      i = e.resolve(r);
    return n ? Qe.near(i) : new ot(i);
  }
  content() {
    return new c(i.from(this.node), 0, 0);
  }
  eq(e) {
    return e instanceof ot && e.anchor == this.anchor;
  }
  toJSON() {
  ...
  static fromJSON(e, t) {
    ...
    return new ot(e.resolve(t.anchor));
  }
  static create(e, t) {
    return new ot(e.resolve(t));
  }
  static isSelectable(e) {
    return !e.isText && !1 !== e.type.spec.selectable;
  }
}
((ot.prototype.visible = !1), Qe.jsonID("node", ot));
class st {
  constructor(e) {
    this.anchor = e;
  }
  map(e) {
    ...
    return t ? new it(n, n) : new st(n);
  }
  resolve(e) {
    let t = e.resolve(this.anchor),
      n = t.nodeAfter;
    return n && ot.isSelectable(n) ? new ot(t) : Qe.near(t);
  }
}
class lt extends Qe {
  constructor(e) {
...
function ht(e, t, n, r, i, o = !1) {
  if (t.inlineContent) return rt.create(e, n);
  for (let s = r - (i > 0 ? 0 : 1); i > 0 ? s < t.childCount : s >= 0; s += i) {
    let r = t.child(s);
    if (r.isAtom) {
      if (!o && ot.isSelectable(r)) return ot.create(e, n - (i < 0 ? r.nodeSize : 0));
    } else {
      let t = ht(e, r, n + i, i < 0 ? r.childCount : 0, i, o);
      if (t) return t;
    }
    n += r.nodeSize * i;
  }
...
function ct(e, t, n) {
  ...
  let i,
    o = e.steps[r];
  (o instanceof Ce || o instanceof Oe) &&
    (e.mapping.maps[r].forEach((e, t, n, r) => {
      null == i && (i = r);
    }),
    e.setSelection(Qe.near(e.doc.resolve(i), n)));
}
class dt extends Ze {
  constructor(e) {
    (super(e.doc),
  ...
  replaceSelectionWith(e, t = !0) {
    ...
    return (
      t && (e = e.mark(this.storedMarks || (n.empty ? n.$from.marks() : n.$from.marksAcross(n.$to) || a.none))),
  ...
  insertText(e, t, n) {
    ...
    if (null == t) return e ? this.replaceSelectionWith(r.text(e), !0) : this.deleteSelection();
    {
      ...
      return (
        ...
        this.selection.empty || this.setSelection(Qe.near(this.selection.$to)),
        this
      );
    }
  }
...
class ut {
  constructor(e, t, n) {
    ((this.name = e), (this.init = pt(t.init, n)), (this.apply = pt(t.apply, n)));
  }
}
const ft = [
  new ut("doc", { init: (e) => e.doc || e.schema.topNodeType.createAndFill(), apply: (e) => e.doc }),
  new ut("selection", { init: (e, t) => e.selection || Qe.atStart(t.doc), apply: (e) => e.selection }),
  new ut("storedMarks", {
    init: (e) => e.storedMarks || null,
    apply: (e, t, n, r) => (r.selection.$cursor ? e.storedMarks : null),
  }),
  new ut("scrollToSelection", { init: () => 0, apply: (e, t) => (e.scrolledIntoView ? t + 1 : t) }),
];
class mt {
  constructor(e, t) {
    ((this.schema = e),
      ...
      t &&
        t.forEach((e) => {
          ...
          (this.plugins.push(e),
            ...
            e.spec.state && this.fields.push(new ut(e.key, e.spec.state, e)));
        }));
  }
}
class gt {
    ...
    for (;;) {
      ...
      for (let o = 0; o < this.config.plugins.length; o++) {
        ...
        if (s.spec.appendTransaction) {
          let l = r ? r[o].n : 0,
            a = r ? r[o].state : this,
            h = l < t.length && s.spec.appendTransaction.call(s, l ? t.slice(l) : t, a, n);
          if (h && n.filterTransaction(h, o)) {
            if ((h.setMeta("appendedTransaction", e), !r)) {
              r = [];
              for (let e = 0; e < this.config.plugins.length; e++)
                r.push(e < o ? { state: n, n: t.length } : { state: this, n: 0 });
            }
  ...
  static create(e) {
    let t = new mt(e.doc ? e.doc.type.schema : e.schema, e.plugins),
      n = new gt(t);
    for (let r = 0; r < t.fields.length; r++) n[t.fields[r].name] = t.fields[r].init(e, n);
    return n;
  }
  reconfigure(e) {
    let t = new mt(this.schema, e.plugins),
      n = t.fields,
      r = new gt(t);
    for (let i = 0; i < n.length; i++) {
      let t = n[i].name;
      r[t] = this.hasOwnProperty(t) ? this[t] : n[i].init(e, r);
    }
    return r;
  }
  toJSON(e) {
  ...
  static fromJSON(e, t, n) {
    ...
    let r = new mt(e.schema, e.plugins),
      i = new gt(r);
    return (
      r.fields.forEach((r) => {
        if ("doc" == r.name) i.doc = T.fromJSON(e.schema, t.doc);
        else if ("selection" == r.name) i.selection = Qe.fromJSON(i.doc, t.selection);
        else if ("storedMarks" == r.name) t.storedMarks && (i.storedMarks = t.storedMarks.map(e.schema.markFromJSON));
        else {
          if (n)
            for (let o in n) {
              let s = n[o],
                l = s.spec.state;
              if (s.key == r.name && l && l.fromJSON && Object.prototype.hasOwnProperty.call(t, o))
                return void (i[r.name] = l.fromJSON.call(s, e, t[o], i));
            }
          i[r.name] = r.init(e, i);
        }
      }),
...
function yt(e, t, n) {
  for (let r in e) {
    let i = e[r];
    (i instanceof Function ? (i = i.bind(t)) : "handleDOMEvents" == r && (i = yt(i, t, {})), (n[r] = i));
  }
  return n;
}
class wt {
  constructor(e) {
    ((this.spec = e),
      (this.props = {}),
      e.props && yt(e.props, this, this.props),
      (this.key = e.key ? e.key.key : xt("plugin")));
  }
  getState(e) {
    return e[this.key];
  }
...
function xt(e) {
  return e in vt ? e + "$" + ++vt[e] : ((vt[e] = 0), e + "$");
}
class bt {
  constructor(e = "key") {
    this.key = xt(e);
...
const Ct = function (e, t, n) {
    let r = Mt || (Mt = document.createRange());
    return (r.setEnd(e, null == n ? e.nodeValue.length : n), r.setStart(e, t || 0), r);
  },
  Ot = function (e, t, n, r) {
    return n && (Tt(e, t, n, r, -1) || Tt(e, t, n, r, 1));
  },
...
function Tt(e, t, n, r, i) {
  for (var o; ; ) {
    ...
    if (t == (i < 0 ? 0 : Dt(e))) {
      let n = e.parentNode;
      if (!n || 1 != n.nodeType || Et(e) || Nt.test(e.nodeName) || "false" == e.contentEditable) return !1;
      ((t = St(e) + (i < 0 ? 0 : 1)), (e = n));
    } else {
...
const At = function (e) {
  return e.focusNode && Ot(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset);
};
function $t(e, t) {
  let n = document.createEvent("Event");
  return (n.initEvent("keydown", !0, !0), (n.keyCode = e), (n.key = n.code = t), n);
}
const Rt = "undefined" != typeof navigator ? navigator : null,
  It = "undefined" != typeof document ? document : null,
  zt = (Rt && Rt.userAgent) || "",
  Pt = /Edge\/(\d+)/.exec(zt),
  Bt = /MSIE \d/.exec(zt),
  Vt = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(zt),
  Ft = !!(Bt || Vt || Pt),
  Lt = Bt ? document.documentMode : Vt ? +Vt[1] : Pt ? +Pt[1] : 0,
  Wt = !Ft && /gecko\/(\d+)/i.test(zt);
Wt && (/Firefox\/(\d+)/.exec(zt) || [0, 0])[1];
const Jt = !Ft && /Chrome\/(\d+)/.exec(zt),
  qt = !!Jt,
  jt = Jt ? +Jt[1] : 0,
  _t = !Ft && !!Rt && /Apple Computer/.test(Rt.vendor),
  Kt = _t && (/Mobile\/\w+/.test(zt) || (!!Rt && Rt.maxTouchPoints > 2)),
  Ht = Kt || (!!Rt && /Mac/.test(Rt.platform)),
  Yt = !!Rt && /Win/.test(Rt.platform),
  Ut = /Android \d/.test(zt),
  Gt = !!It && "webkitFontSmoothing" in It.documentElement.style,
  Zt = Gt ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Xt(e) {
...
function tn(e, t, n) {
  ...
  for (let s = n || e.dom; s; ) {
    ...
    let e = s,
      ...
      h = 0;
    if (
      (t.top < l.top + Qt(r, "top")
        ? (h = -(l.top - t.top + Qt(i, "top")))
        : t.bottom > l.bottom - Qt(r, "bottom") &&
          (h =
            t.bottom - t.top > l.bottom - l.top ? t.top + Qt(i, "top") - l.top : t.bottom - l.bottom + Qt(i, "bottom")),
      t.left < l.left + Qt(r, "left")
        ? (a = -(l.left - t.left + Qt(i, "left")))
        : t.right > l.right - Qt(r, "right") && (a = t.right - l.right + Qt(i, "right")),
      a || h)
    )
      if (n) o.defaultView.scrollBy(a, h);
        ...
        let i = e.scrollLeft - n,
          o = e.scrollTop - r;
        t = { left: t.left - i, top: t.top - o, right: t.right - i, bottom: t.bottom - o };
      }
    let c = n ? "fixed" : getComputedStyle(s).position;
    if (/^(fixed|sticky)$/.test(c)) break;
    s = "absolute" == c ? s.offsetParent : kt(s);
  }
}
function nn(e) {
  let t = [],
    n = e.ownerDocument;
  for (let r = e; r && (t.push({ dom: r, top: r.scrollTop, left: r.scrollLeft }), e != n); r = kt(r));
  return t;
}
function rn(e, t) {
  for (let n = 0; n < e.length; n++) {
...
function sn(e, t) {
  let n,
    ...
    a = t.top,
    h = t.top;
  for (let c = e.firstChild, d = 0; c; c = c.nextSibling, d++) {
    let e;
    if (1 == c.nodeType) e = c.getClientRects();
    else {
      if (3 != c.nodeType) continue;
      e = Ct(c).getClientRects();
    }
    for (let p = 0; p < e.length; p++) {
      let u = e[p];
      if (u.top <= a && u.bottom >= h) {
        ((a = Math.max(u.bottom, a)), (h = Math.min(u.top, h)));
        ...
        if (e < s) {
          ((n = c),
            ...
            1 == c.nodeType && e && (l = d + (t.left >= (u.left + u.right) / 2 ? 1 : 0)));
          continue;
        }
      } else
        u.top > t.top &&
          ...
          u.left <= t.left &&
          u.right >= t.left &&
          ((i = c), (o = { left: Math.max(u.left, Math.min(u.right, t.left)), top: u.top }));
      !n && ((t.left >= u.right && t.top >= u.top) || (t.left >= u.left && t.top >= u.bottom)) && (l = d + 1);
    }
  }
  return (
    !n && i && ((n = i), (r = o), (s = 0)),
    n && 3 == n.nodeType
      ? (function (e, t) {
          let n,
            r = e.nodeValue.length,
            i = document.createRange();
          for (let o = 0; o < r; o++) {
            (i.setEnd(e, o + 1), i.setStart(e, o));
            let r = dn(i, 1);
            if (r.top != r.bottom && ln(t, r)) {
              n = { node: e, offset: o + (t.left >= (r.left + r.right) / 2 ? 1 : 0) };
              break;
            }
          }
          return (i.detach(), n || { node: e, offset: 0 });
        })(n, r)
      : !n || (s && 1 == n.nodeType)
        ? { node: e, offset: l }
        : sn(n, r)
...
function hn(e, t) {
    ...
    o = (function (e, t, n) {
      if (e.caretPositionFromPoint)
        try {
          ...
          if (r) return { node: r.offsetNode, offset: Math.min(Dt(r.offsetNode), r.offset) };
        } catch (r) {}
      if (e.caretRangeFromPoint) {
        let r = e.caretRangeFromPoint(t, n);
        if (r) return { node: r.startContainer, offset: Math.min(Dt(r.startContainer), r.startOffset) };
      }
    })(r, t.left, t.top);
  o && ({ node: n, offset: i } = o);
  let s,
  ...
  if (!l || !e.dom.contains(1 != l.nodeType ? l.parentNode : l)) {
    ...
    if (!ln(t, n)) return null;
    if (((l = an(e.dom, t, n)), !l)) return null;
  }
  if (_t) for (let h = l; n && h; h = kt(h)) h.draggable && (n = void 0);
  if (
    ((l = (function (e, t) {
      let n = e.parentNode;
    ...
    if (Wt && 1 == n.nodeType && ((i = Math.min(i, n.childNodes.length)), i < n.childNodes.length)) {
      let e,
        r = n.childNodes[i];
      "IMG" == r.nodeName && (e = r.getBoundingClientRect()).right <= t.left && e.bottom > t.top && i++;
    }
    let r;
    (Gt &&
      i &&
        ...
        : (0 != i && 1 == n.nodeType && "BR" == n.childNodes[i - 1].nodeName) ||
          (s = (function (e, t, n, r) {
            ...
            for (let o = t, s = !1; o != e.dom; ) {
              let t,
                n = e.docView.nearestDesc(o, !0);
              if (!n) return null;
              if (
                1 == n.dom.nodeType &&
                ((n.node.isBlock && n.parent) || !n.contentDOM) &&
                ((t = n.dom.getBoundingClientRect()).width || t.height) &&
                (n.node.isBlock &&
                  n.parent &&
                  !/^T(R|BODY|HEAD|FOOT)$/.test(n.dom.nodeName) &&
                  ((!s && t.left > r.left) || t.top > r.top
                    ? (i = n.posBefore)
                    : ((!s && t.right < r.left) || t.bottom < r.top) && (i = n.posAfter),
                  (s = !0)),
                !n.contentDOM && i < 0 && !n.node.isText)
              )
                return (n.node.isBlock ? r.top < (t.top + t.bottom) / 2 : r.left < (t.left + t.right) / 2)
                  ? n.posBefore
                  : n.posAfter;
              o = n.dom.parentNode;
            }
  ...
  let a = e.docView.nearestDesc(l, !0);
...
function dn(e, t) {
  ...
  return Array.prototype.find.call(n, cn) || e.getBoundingClientRect();
}
const pn = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function un(e, t, n) {
  let { node: r, offset: i, atom: o } = e.docView.domFromPos(t, n < 0 ? -1 : 1),
    s = Gt || Wt;
  if (3 == r.nodeType) {
    if (!s || (!pn.test(r.nodeValue) && (n < 0 ? i : i != r.nodeValue.length))) {
      let e = i,
        t = i,
        o = n < 0 ? 1 : -1;
      return (
        n < 0 && !i ? (t++, (o = -1)) : n >= 0 && i == r.nodeValue.length ? (e--, (o = 1)) : n < 0 ? e-- : t++,
        fn(dn(Ct(r, e, t), o), o < 0)
      );
    }
    {
      let e = dn(Ct(r, i, i), n);
      if (Wt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let t = dn(Ct(r, i - 1, i - 1), -1);
        if (t.top == e.top) {
          let n = dn(Ct(r, i, i + 1), -1);
          if (n.top != e.top) return fn(n, n.left < t.left);
        }
      }
      return e;
    }
  ...
  if (!e.state.doc.resolve(t - (o || 0)).parent.inlineContent) {
    if (null == o && i && (n < 0 || i == Dt(r))) {
      let e = r.childNodes[i - 1];
      if (1 == e.nodeType) return mn(e.getBoundingClientRect(), !1);
    }
    if (null == o && i < Dt(r)) {
      let e = r.childNodes[i];
      if (1 == e.nodeType) return mn(e.getBoundingClientRect(), !0);
    }
    return mn(r.getBoundingClientRect(), n >= 0);
  }
  if (null == o && i && (n < 0 || i == Dt(r))) {
    let e = r.childNodes[i - 1],
      t =
        3 == e.nodeType
          ...
          : 1 != e.nodeType || ("BR" == e.nodeName && e.nextSibling)
            ? null
            : e;
    if (t) return fn(dn(t, 1), !1);
  }
  if (null == o && i < Dt(r)) {
    let e = r.childNodes[i];
    for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords; ) e = e.nextSibling;
    let t = e ? (3 == e.nodeType ? Ct(e, 0, s ? 0 : 1) : 1 == e.nodeType ? e : null) : null;
    if (t) return fn(dn(t, -1), !0);
  }
  return fn(dn(3 == r.nodeType ? Ct(r) : r, -n), n >= 0);
}
function fn(e, t) {
        ...
        "up" == n || "down" == n
              ...
              return gn(e, t, () => {
                ...
                for (let e = t.firstChild; e; e = e.nextSibling) {
                  ...
                  if (1 == e.nodeType) t = e.getClientRects();
                    ...
                    t = Ct(e, 0, e.nodeValue.length).getClientRects();
                  }
          ...
          : (function (e, t, n) {
              ...
              let i = r.parentOffset,
                ...
                l = e.domSelection();
              return l
                ? yn.test(r.parent.textContent) && l.modify
                  ? gn(e, t, () => {
                      let { focusNode: t, focusOffset: i, anchorNode: o, anchorOffset: s } = e.domSelectionRange(),
                        a = l.caretBidiLevel;
                      l.modify("move", n, "character");
                      let h = r.depth ? e.docView.domAfterPos(r.before()) : e.dom,
                        { focusNode: c, focusOffset: d } = e.domSelectionRange(),
                        p = (c && !h.contains(1 == c.nodeType ? c : c.parentNode)) || (t == c && i == d);
                      try {
                        (l.collapse(o, s), t && (t != o || i != s) && l.extend && l.extend(t, i));
                      } catch (u) {}
...
class Sn {
  ...
  localPosFromDOM(e, t, n) {
    ...
    let r;
    if (e == this.dom && this.contentDOM) r = t > St(this.contentDOM);
  ...
  nearestDesc(e, t = !1) {
    for (let n = !0, r = e; r; r = r.parentNode) {
      let i,
        o = this.getDesc(r);
      if (o && (!t || o.node)) {
        if (!n || !(i = o.nodeDOM) || (1 == i.nodeType ? i.contains(1 == e.nodeType ? e : e.parentNode) : i == e))
          return o;
        n = !1;
      }
    }
  ...
  domFromPos(e, t) {
    ...
    for (let i; n && !(i = this.children[n - 1]).size && i instanceof kn && i.side >= 0; n--);
    if (t <= 0) {
      let e,
        r = !0;
      ...
      return e && t && r && !e.border && !e.domAtom
        ...
        : { node: this.contentDOM, offset: e ? St(e.dom) + 1 : 0 };
    }
    {
      let e,
        r = !0;
      for (
        ;
        (e = n < this.children.length ? this.children[n] : null), e && e.dom.parentNode != this.contentDOM;
        n++, r = !1
      );
      return e && r && !e.border && !e.domAtom
        ? e.domFromPos(0, t)
        : { node: this.contentDOM, offset: e ? St(e.dom) : this.contentDOM.childNodes.length };
    }
  }
  parseRange(e, t, n = 0) {
    ...
    for (let o = n, s = 0; ; s++) {
      ...
      if (-1 == r && e <= l) {
        let i = o + n.border;
        if (e >= i && t <= l - n.border && n.node && n.contentDOM && this.contentDOM.contains(n.contentDOM))
  ...
  setSelection(e, t, n, r = !1) {
    ...
    for (let u = 0, f = 0; u < this.children.length; u++) {
      let s = this.children[u],
        l = f + s.size;
      if (i > f && o < l) return s.setSelection(e - f - s.border, t - f - s.border, n, r);
      f = l;
    }
      ...
      if (3 == e.nodeType) {
        if (((c = !(!t || "\n" != e.nodeValue[t - 1])), c && t == e.nodeValue.length))
          for (let n, r = e; r; r = r.parentNode) {
            if ((n = r.nextSibling)) {
              "BR" == n.nodeName && (s = l = { node: n.parentNode, offset: St(n) + 1 });
              break;
            }
            let e = r.pmViewDesc;
    ...
    if (Wt && h.focusNode && h.focusNode != l.node && 1 == h.focusNode.nodeType) {
      let e = h.focusNode.childNodes[h.focusOffset];
      e && "false" == e.contentEditable && (r = !0);
    }
    if (
      !(r || (c && _t)) &&
      Ot(s.node, s.offset, h.anchorNode, h.anchorOffset) &&
      Ot(l.node, l.offset, h.focusNode, h.focusOffset)
    )
      return;
    let d = !1;
    if ((a.extend || e == t) && (!c || !Wt)) {
      ...
      if (n == o ? e <= o && t >= n : e < o && t > n) {
        ...
        if (e >= r && t <= s)
          return (
            ...
            void (e != r || t != s || (!i.contentLost && i.dom.parentNode == this.contentDOM)
              ? i.markDirty(e - r, t - r)
              : (i.dirty = 3))
          );
...
class kn extends Sn {
  constructor(e, t, n, r) {
    let i,
      o = t.type.toDOM;
    if (
      ("function" == typeof o && (o = o(n, () => (i ? (i.parent ? i.parent.posBeforeChild(i) : void 0) : r))),
      !t.type.spec.raw)
    ) {
      if (1 != o.nodeType) {
...
class Cn extends Sn {
  ...
  static create(e, t, n, r) {
    ...
    return (
      ...
      new Cn(e, t, o.dom, o.contentDOM || o.dom, o)
    );
  }
  parseRule() {
  ...
  slice(e, t, n) {
    let r = Cn.create(this.parent, this.mark, !0, n),
      i = this.children,
      o = this.size;
    (t < o && (i = Jn(i, t, o, n)), e > 0 && (i = Jn(i, 0, e, n)));
    for (let s = 0; s < i.length; s++) i[s].parent = r;
...
class On extends Sn {
  constructor(e, t, n, r, i, o, s, l, a) {
    (super(e, [], i, o), (this.node = t), (this.outerDeco = n), (this.innerDeco = r), (this.nodeDOM = s));
  }
  static create(e, t, n, r, i, o) {
    let s,
      l = i.nodeViews[t.type.name],
      a = l && l(t, i, () => (s ? (s.parent ? s.parent.posBeforeChild(s) : void 0) : o), n, r),
      h = a && a.dom,
      c = a && a.contentDOM;
    if (t.isText)
      if (h) {
      ...
      let e = oe.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs);
      ({ dom: h, contentDOM: c } = e);
    }
    c ||
      t.isText ||
      "BR" == h.nodeName ||
      (h.hasAttribute("contenteditable") || (h.contentEditable = "false"), t.type.spec.draggable && (h.draggable = !0));
    let d = h;
    return (
      (h = Bn(h, n, t)),
      a
        ? (s = new En(e, t, n, r, h, c || null, d, a, i, o + 1))
        : t.isText
          ? new Tn(e, t, n, r, h, d, i)
          : new On(e, t, n, r, h, c || null, d, i, o + 1)
    );
  }
  parseRule() {
  ...
  matchesNode(e, t, n) {
    return 0 == this.dirty && e.eq(this.node) && Vn(t, this.outerDeco) && n.eq(this.innerDeco);
  }
  get size() {
  ...
  updateChildren(e, t) {
    ...
    (!(function (e, t, n, r) {
      ...
      for (let h = 0; ; ) {
        ...
        for (let e = 0; e < l.length; e++) l[e].to <= o && l.splice(e--, 1);
        ...
        if (p.isText) {
          ...
          e < f && ((a = p.cut(e - o)), (p = p.cut(0, e - o)), (f = e), (u = -1));
        } else for (; s < i.length && i[s].to < f; ) s++;
        (r(p, p.isInline && !p.isLeaf ? l.filter((e) => !e.inline) : l.slice(), t.forChild(o, p), u), (o = f));
      }
    })(
      this.node,
      this.innerDeco,
      (t, i, o) => {
        (t.spec.marks
          ? l.syncToMarks(t.spec.marks, n, e, i)
          : t.type.side >= 0 &&
            !o &&
            l.syncToMarks(i == this.node.childCount ? a.none : this.node.child(i).marks, n, e, i),
          l.placeWidget(t, e, r));
      },
      (t, o, a, h) => {
        let c;
        (l.syncToMarks(t.marks, n, e, h),
          l.findNodeMatch(t, o, a, h) ||
            (s &&
              e.state.selection.from > r &&
              e.state.selection.to < r + t.nodeSize &&
              (c = l.findIndexWithChild(i.node)) > -1 &&
              l.updateNodeAt(t, o, a, c, e)) ||
            l.updateNextNode(t, o, a, e, h, r) ||
            l.addNode(t, o, a, e, r),
          (r += t.nodeSize));
      },
    ),
      ...
      (l.changed || 2 == this.dirty) &&
        ...
        An(this.contentDOM, this.children, e),
        Kt &&
          (function (e) {
  ...
  localCompositionInfo(e, t) {
    ...
    if (!(e.state.selection instanceof rt) || n < t || r > t + this.node.content.size) return null;
      ...
      let e = i.nodeValue,
        o = (function (e, t, n, r) {
          for (let i = 0, o = 0; i < e.childCount && o <= r; ) {
            ...
            if (o >= n) {
              if (o >= r && a.slice(r - t.length - l, r - l) == t) return r - t.length;
              let e = l < r ? a.lastIndexOf(t, r - l - 1) : -1;
              if (e >= 0 && e + t.length + l >= n) return l + e;
              if (n == r && a.length >= r + t.length - l && a.slice(r - l, r - l + t.length) == t) return r;
            }
          }
          return -1;
        })(this.node.content, e, n - t, r - t);
      return o < 0 ? null : { node: i, pos: o, text: e };
    }
  ...
  protectLocalComposition(e, { node: t, pos: n, text: r }) {
    ...
    let o = new Mn(this, i, t, r);
    (e.input.compositionNodes.push(o), (this.children = Jn(this.children, n, n + r.length, e, o)));
  }
  update(e, t, n, r) {
  ...
  updateOuterDeco(e) {
    ...
    let t = 1 != this.nodeDOM.nodeType,
      n = this.dom;
    ((this.dom = zn(this.dom, this.nodeDOM, In(this.outerDeco, this.node, t), In(e, this.node, t))),
...
function Nn(e, t, n, r, i) {
  Bn(r, t, e);
  let o = new On(void 0, e, t, n, r, r, r, i, 0);
...
class Tn extends On {
  ...
  slice(e, t, n) {
    ...
    return new Tn(this.parent, r, this.outerDeco, this.innerDeco, i, i, n);
  }
  markDirty(e, t) {
    (super.markDirty(e, t),
...
function An(e, t, n) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    if (s instanceof Cn) {
      ...
      (An(s.contentDOM, s.children, n), (r = t ? t.nextSibling : e.firstChild));
    }
  }
  for (; r; ) ((r = Fn(r)), (i = !0));
...
function In(e, t, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s) {
      s.nodeName && i.push((r = new $n(s.nodeName)));
      for (let e in s) {
        let o = s[e];
        null != o &&
          (n && 1 == i.length && i.push((r = new $n(t.isInline ? "span" : "div"))),
          "class" == e
...
function zn(e, t, n, r) {
  ...
  for (let o = 0; o < r.length; o++) {
    ...
    if (o) {
      let n;
      ((s && s.nodeName == t.nodeName && i != e && (n = i.parentNode) && n.nodeName.toLowerCase() == t.nodeName) ||
        ((n = document.createElement(t.nodeName)), (n.pmIsDeco = !0), n.appendChild(i), (s = Rn[0])),
        (i = n));
    }
    Pn(i, s || Rn[0], t);
  }
...
function Pn(e, t, n) {
  ...
  if (t.class != n.class) {
    ...
    for (let t = 0; t < r.length; t++) -1 == i.indexOf(r[t]) && e.classList.remove(r[t]);
    for (let t = 0; t < i.length; t++) -1 == r.indexOf(i[t]) && e.classList.add(i[t]);
...
function Bn(e, t, n) {
  return zn(e, e, Rn, In(t, n, 1 != e.nodeType));
}
function Vn(e, t) {
  if (e.length != t.length) return !1;
...
class Ln {
  ...
  syncToMarks(e, t, n, r) {
    ...
    for (
      ;
      i < s && (i == o - 1 ? this.top : this.stack[(i + 1) << 1]).matchesMark(e[i]) && !1 !== e[i].type.spec.spanning;
    )
      i++;
    for (; i < o; )
      (this.destroyRest(), (this.top.dirty = 0), (this.index = this.stack.pop()), (this.top = this.stack.pop()), o--);
    for (; o < e.length; ) {
      this.stack.push(this.top, this.index + 1);
      let i = -1,
        s = this.top.children.length;
      r < this.preMatch.index && (s = Math.min(this.index + 3, s));
      for (let t = this.index; t < s; t++) {
      ...
      if (i > -1)
        ...
        let r = Cn.create(this.top, e[o], t, n);
  ...
  findNodeMatch(e, t, n, r) {
    ...
    if (
      ...
      (i = this.preMatch.matches[r - this.preMatch.index]).parent == this.top &&
      i.matchesNode(e, t, n)
    )
  ...
  updateNodeAt(e, t, n, r, i) {
    ...
    return (
      ...
      !!o.update(e, t, n, i) && (this.destroyBetween(this.index, r), this.index++, !0)
    );
  }
      ...
      if (l instanceof On) {
        ...
        if (!d && (h = this.recreateWrapper(l, e, t, n, r, o)))
          return (
            ...
            h.contentDOM && ((h.dirty = 2), h.updateChildren(r, o + 1), (h.dirty = 0)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, t, n, r, i, o) {
    if (
      ...
      return null;
    let s = On.create(this.top, t, n, r, i, o);
    if (s.contentDOM) {
  ...
  addNode(e, t, n, r, i) {
    let o = On.create(this.top, e, t, n, r, i);
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof Cn; ) ((t = e), (e = t.children[t.children.length - 1]));
    (!e ||
      !(e instanceof Tn) ||
      /\n$/.test(e.node.text) ||
      (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
      ((_t || qt) && e && "false" == e.dom.contentEditable && this.addHackNode("IMG", t),
  ...
  if (At(n)) {
    ...
    if (n instanceof e.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
      ...
      for (let r = 0; r < n.rangeCount; r++) {
        ...
        ((t = Math.min(t, e.docView.posFromDOM(o.startContainer, o.startOffset, 1))),
          (i = Math.max(i, e.docView.posFromDOM(o.endContainer, o.endOffset, -1))));
      }
      if (t < 0) return null;
      (([l, s] = i == e.state.selection.anchor ? [i, t] : [t, i]), (h = r.resolve(s)));
    } else l = e.docView.posFromDOM(n.anchorNode, n.anchorOffset, 1);
    if (l < 0) return null;
  }
  let c = r.resolve(l);
  if (!a) {
    a = Xn(e, c, h, "pointer" == t || (e.state.selection.head < h.pos && !o) ? 1 : -1);
  }
  return a;
}
function jn(e) {
  return e.editable ? e.hasFocus() : er(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function _n(e, t = !1) {
  let n = e.state.selection;
  if ((Gn(e, n), jn(e))) {
    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && qt) {
      let t = e.domSelectionRange(),
        n = e.domObserver.currentSelection;
      if (t.anchorNode && n.anchorNode && Ot(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset))
    ...
    if ((e.domObserver.disconnectSelection(), e.cursorWrapper))
      !(function (e) {
        ...
        let n = e.cursorWrapper.dom,
          r = "IMG" == n.nodeName;
        r ? t.collapse(n.parentNode, St(n) + 1) : t.collapse(n, 0);
        !r && !e.state.selection.visible && Ft && Lt <= 11 && ((n.disabled = !0), (n.disabled = !1));
      })(e);
    else {
      let r,
        i,
      ...
      (!Kn ||
        n instanceof rt ||
        (n.$from.parent.inlineContent || (r = Hn(e, n.from)),
        n.empty || n.$from.parent.inlineContent || (i = Hn(e, n.to))),
        e.docView.setSelection(o, s, e, t),
        Kn && (r && Un(r), i && Un(i)),
        n.visible
                ...
                t.addEventListener(
                  ...
                  (e.input.hideSelectionGuard = () => {
                    (n.anchorNode == r && n.anchorOffset == i) ||
                      (t.removeEventListener("selectionchange", e.input.hideSelectionGuard),
                      setTimeout(() => {
                        (jn(e) && !e.state.selection.visible) || e.dom.classList.remove("ProseMirror-hideselection");
                      }, 20));
                  }),
                );
              })(e)));
...
function Yn(e) {
  return ((e.contentEditable = "true"), _t && e.draggable && ((e.draggable = !1), (e.wasDraggable = !0)), e);
}
function Un(e) {
...
function Gn(e, t) {
  if (t instanceof ot) {
    ...
    n != e.lastSelectedViewDesc && (Zn(e), n && n.selectNode(), (e.lastSelectedViewDesc = n));
  } else Zn(e);
}
function Zn(e) {
...
function Xn(e, t, n, r) {
  return e.someProp("createSelectionBetween", (r) => r(e, t, n)) || rt.between(t, n, r);
}
function Qn(e) {
  return !(e.editable && !e.hasFocus()) && er(e);
}
function er(e) {
  let t = e.domSelectionRange();
...
function rr(e, t, n) {
  ...
  if (!(r instanceof rt)) {
    if (r instanceof ot && r.node.isInline) return nr(e, new rt(t > 0 ? r.$to : r.$from));
    {
      let n = tr(e.state, t);
      return !!n && nr(e, n);
    }
  ...
  if (n.indexOf("s") > -1) {
    ...
    return nr(e, new rt(r.$anchor, o));
  }
  if (!r.empty) return !1;
  if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
    let n = tr(e.state, t);
    return !!(n && n instanceof ot) && nr(e, n);
  }
  if (!(Ht && n.indexOf("m") > -1)) {
    let n,
      i = r.$head,
    ...
    return (
      !!(o.isAtom || ((n = e.docView.descAt(s)) && !n.contentDOM)) &&
      (ot.isSelectable(o)
        ? nr(e, new ot(t < 0 ? e.state.doc.resolve(i.pos - o.nodeSize) : i))
        : !!Gt && nr(e, new rt(e.state.doc.resolve(t < 0 ? s : s + o.nodeSize))))
    );
  }
}
function ir(e) {
  ...
  return t < 0
    ? (function (e) {
        ...
        let i,
          o,
          s = !1;
        Wt && 1 == n.nodeType && r < ir(n) && or(n.childNodes[r], -1) && (s = !0);
        for (;;)
          if (r > 0) {
            ...
            if (lr(n)) break;
            {
              ...
              for (; t && or(t, -1); ) ((i = n.parentNode), (o = St(t)), (t = t.previousSibling));
              if (t) ((n = t), (r = ir(n)));
              else {
    ...
    : (function (e) {
        ...
        for (;;)
          if (r < s) {
            if (1 != n.nodeType) break;
            if (!or(n.childNodes[r], 1)) break;
            ((i = n), (o = ++r));
          } else {
            if (lr(n)) break;
            {
              let t = n.nextSibling;
              for (; t && or(t, 1); ) ((i = t.parentNode), (o = St(t) + 1), (t = t.nextSibling));
              if (t) ((n = t), (r = 0), (s = ir(n)));
              else {
                if (((n = n.parentNode), n == e.dom)) break;
                r = s = 0;
...
function ar(e, t, n) {
  if (3 != t.nodeType) {
    let e, r;
    (r = (function (e, t) {
      for (; e && t == e.childNodes.length && !Et(e); ) ((t = St(e) + 1), (e = e.parentNode));
      ...
      ? ((t = r), (n = 0))
      : (e = (function (e, t) {
          for (; e && !t && !Et(e); ) ((t = St(e)), (e = e.parentNode));
          for (; e && t; ) {
            let n = e.childNodes[t - 1];
            if (3 == n.nodeType) return n;
            if (1 == n.nodeType && "false" == n.contentEditable) break;
...
function hr(e, t) {
  ...
  if (!qt && !Yt && n.parent.inlineContent) {
...
function cr(e, t, n) {
  let r = e.state.selection;
  if ((r instanceof rt && !r.empty) || n.indexOf("s") > -1) return !1;
  if (Ht && n.indexOf("m") > -1) return !1;
  let { $from: i, $to: o } = r;
  if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
    let n = tr(e.state, t);
    if (n && n instanceof ot) return nr(e, n);
  }
  if (!i.parent.inlineContent) {
    let n = t < 0 ? i : o,
      s = r instanceof lt ? Qe.near(n, t) : Qe.findFrom(n, t);
    return !!s && nr(e, s);
  }
  return !1;
}
function dr(e, t) {
  if (!(e.state.selection instanceof rt)) return !0;
...
function ur(e, t) {
  ...
  if (8 == n || (Ht && 72 == n && "c" == r)) return dr(e, -1) || sr(e, -1);
  if ((46 == n && !t.shiftKey) || (Ht && 68 == n && "c" == r)) return dr(e, 1) || sr(e, 1);
  if (13 == n || 27 == n) return !0;
  if (37 == n || (Ht && 66 == n && "c" == r)) {
    let t = 37 == n ? ("ltr" == hr(e, e.state.selection.from) ? -1 : 1) : -1;
    return rr(e, t, r) || sr(e, t);
  }
  if (39 == n || (Ht && 70 == n && "c" == r)) {
    let t = 39 == n ? ("ltr" == hr(e, e.state.selection.from) ? 1 : -1) : 1;
    return rr(e, t, r) || sr(e, t);
  }
  return 38 == n || (Ht && 80 == n && "c" == r)
    ? cr(e, -1, r) || sr(e, -1)
    : 40 == n || (Ht && 78 == n && "c" == r)
      ? (function (e) {
          if (!_t || e.state.selection.$head.parentOffset > 0) return !1;
          let { focusNode: t, focusOffset: n } = e.domSelectionRange();
          if (t && 1 == t.nodeType && 0 == n && t.firstChild && "false" == t.firstChild.contentEditable) {
            let n = t.firstChild;
            (pr(e, n, "true"), setTimeout(() => pr(e, n, "false"), 20));
          }
          return !1;
        })(e) ||
        cr(e, 1, r) ||
        sr(e, 1)
      : r == (Ht ? "m" : "c") && (66 == n || 73 == n || 89 == n || 90 == n);
}
function fr(e, t) {
  ...
  let n = [],
    { content: r, openStart: i, openEnd: o } = t;
  ...
  let s = e.someProp("clipboardSerializer") || oe.fromSchema(e.state.schema),
    l = Mr(),
  ...
  let h,
    c = a.firstChild,
    d = 0;
  for (; c && 1 == c.nodeType && (h = Sr[c.nodeName.toLowerCase()]); ) {
    for (let e = h.length - 1; e >= 0; e--) {
      let t = l.createElement(h[e]);
  ...
  return (
    c && 1 == c.nodeType && c.setAttribute("data-pm-slice", `${i} ${o}${d ? ` -${d}` : ""} ${JSON.stringify(n)}`),
    {
      dom: a,
...
function mr(e, t, n, r, o) {
  ...
  if (h) {
    if (
      ...
      return (
        (l = new c(i.from(e.state.schema.text(t.replace(/\r\n?/g, "\n"))), 0, 0)),
    ...
    (e.someProp("transformPastedHTML", (t) => {
      ...
      (s = (function (e) {
        ...
        let n,
          r = Mr().createElement("div"),
          i = /<([a-z][^>\s]+)/i.exec(e);
        (n = i && Sr[i[1].toLowerCase()]) &&
          (e =
            n.map((e) => "<" + e + ">").join("") +
            e +
            n
        ...
        if (
          ((r.innerHTML = (function (e) {
            ...
            if (!t) return e;
            Cr || (Cr = t.defaultPolicy || t.createPolicy("ProseMirrorClipboard", { createHTML: (e) => e }));
            return Cr.createHTML(e);
          })(e)),
          n)
        )
          for (let o = 0; o < n.length; o++) r = r.querySelector(n[o]) || r;
        return r;
      })(n)),
      Gt &&
        (function (e) {
          let t = e.querySelectorAll(qt ? "span:not([class]):not([style])" : "span.Apple-converted-space");
  ...
  if (!l) {
    let t = e.someProp("clipboardParser") || e.someProp("domParser") || U.fromSchema(e.state.schema);
    l = t.parseSlice(s, {
      preserveWhitespace: !(!h && !p),
      context: o,
      ruleFromNode: (e) =>
        "BR" != e.nodeName || e.nextSibling || !e.parentNode || gr.test(e.parentNode.nodeName) ? null : { ignore: !0 },
    });
  }
  if (p)
    l = (function (e, t) {
      ...
      for (let h = n.length - 2; h >= 0; h -= 2) {
        let e = r.nodes[n[h]];
        if (!e || e.hasRequiredAttrs()) break;
        ((o = i.from(e.create(n[h + 1], o))), s++, l++);
      }
      return new c(o, s, l);
    })(br(l, +p[1], +p[2]), p[4]);
  else if (
        ...
        for (let n = t.depth; n >= 0; n--) {
          ...
          if (
            (e.forEach((e) => {
              ...
              if (!n) return (s = null);
              if ((t = s.length && r.length && wr(n, r, e, s[s.length - 1], 0))) s[s.length - 1] = t;
              else {
                s.length && (s[s.length - 1] = vr(s[s.length - 1], r.length));
                let t = yr(e, n);
...
function yr(e, t, n = 0) {
  for (let r = t.length - 1; r >= n; r--) e = t[r].create(null, i.from(e));
  return e;
}
function wr(e, t, n, r, o) {
  if (o < e.length && o < t.length && e[o] == t[o]) {
    let s = wr(e, t, n, r.lastChild, o + 1);
    ...
    if (r.contentMatchAt(r.childCount).matchType(o == e.length - 1 ? n.type : e[o + 1]))
      return r.copy(r.content.append(i.from(yr(n, e, o + 1))));
  }
}
function vr(e, t) {
  if (0 == t) return e;
  let n = e.content.replaceChild(e.childCount - 1, vr(e.lastChild, t - 1)),
      ...
      (a =
        t < 0
          ? l
              ...
              .fillBefore(a, s <= o)
              .append(a)
          : a.append(l.contentMatchAt(l.childCount).fillBefore(i.empty, !0))),
    e.replaceChild(t < 0 ? 0 : e.childCount - 1, l.copy(a))
  );
}
function br(e, t, n) {
  return (
    t < e.openStart && (e = new c(xr(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)),
    n < e.openEnd && (e = new c(xr(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
    e
  );
}
const Sr = {
...
let kr = null;
function Mr() {
  return kr || (kr = document.implementation.createHTMLDocument("title"));
}
let Cr = null;
const Or = {},
  Nr = {},
  Tr = { touchstart: !0, touchmove: !0 };
class Dr {
  constructor() {
    ((this.shiftKey = !1),
      (this.mouseDown = null),
...
function Ar(e) {
  e.someProp("handleDOMEvents", (t) => {
    for (let n in t)
      e.input.eventHandlers[n] || e.dom.addEventListener(n, (e.input.eventHandlers[n] = (t) => $r(e, t)));
  });
}
function $r(e, t) {
...
function zr(e, t, n, r, i) {
  ...
  for (let s = o.depth + 1; s > 0; s--)
    if (
      e.someProp(t, (t) =>
        s > o.depth ? t(e, n, o.nodeAfter, o.before(s), i, !0) : t(e, n, o.node(s), o.before(s), i, !1),
      )
    )
      return !0;
  return !1;
    ...
    (i
      ? (function (e, t) {
          ...
          let n,
            r,
            i = e.state.selection;
          i instanceof ot && (n = i.node);
          let o = e.state.doc.resolve(t);
          for (let s = o.depth + 1; s > 0; s--) {
            let e = s > o.depth ? o.nodeAfter : o.node(s);
            if (ot.isSelectable(e)) {
              r =
                n && i.$from.depth > 0 && s >= i.$from.depth && o.before(i.$from.depth + 1) == i.$from.pos
                  ? o.before(i.$from.depth)
                  : o.before(s);
              break;
            }
          }
          return null != r && (Pr(e, ot.create(e.state.doc, r)), !0);
        })(e, n)
      : (function (e, t) {
          if (-1 == t) return !1;
          let n = e.state.doc.resolve(t),
            r = n.nodeAfter;
          return !!(r && r.isAtom && ot.isSelectable(r)) && (Pr(e, new ot(n)), !0);
        })(e, n))
  );
}
function Vr(e, t, n, r) {
  return zr(e, "handleDoubleClickOn", t, n, r) || e.someProp("handleDoubleClick", (n) => n(e, t, r));
}
function Fr(e, t, n, r) {
  return (
    zr(e, "handleTripleClickOn", t, n, r) ||
    e.someProp("handleTripleClick", (n) => n(e, t, r)) ||
    (function (e, t, n) {
      if (0 != n.button) return !1;
      let r = e.state.doc;
      if (-1 == t) return !!r.inlineContent && (Pr(e, rt.create(r, 0, r.content.size)), !0);
      let i = r.resolve(t);
      for (let o = i.depth + 1; o > 0; o--) {
        let t = o > i.depth ? i.nodeAfter : i.node(o),
          n = i.before(o);
        if (t.inlineContent) Pr(e, rt.create(r, n + 1, n + 1 + t.content.size));
        else {
          if (!ot.isSelectable(t)) continue;
          Pr(e, ot.create(r, n));
        }
        return !0;
      }
...
((Nr.keydown = (e, t) => {
  ...
  if (
    ...
    !qr(e, n) &&
      ((e.input.lastKeyCode = n.keyCode), (e.input.lastKeyCodeTime = Date.now()), !Ut || !qt || 13 != n.keyCode))
  )
    if ((229 != n.keyCode && e.domObserver.forceFlush(), !Kt || 13 != n.keyCode || n.ctrlKey || n.altKey || n.metaKey))
      e.someProp("handleKeyDown", (t) => t(e, n)) || ur(e, n) ? n.preventDefault() : Er(e, "key");
    else {
      let t = Date.now();
      ((e.input.lastIOSEnter = t),
        (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          e.input.lastIOSEnter == t &&
            (e.someProp("handleKeyDown", (t) => t(e, $t(13, "Enter"))), (e.input.lastIOSEnter = 0));
        }, 200)));
    }
}),
  (Nr.keyup = (e, t) => {
  ...
  (Nr.keypress = (e, t) => {
    let n = t;
    if (qr(e, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Ht && n.metaKey)) return;
    ...
    if (!(r instanceof rt && r.$from.sameParent(r.$to))) {
      ...
      (/[\r\n]/.test(t) || e.someProp("handleTextInput", (n) => n(e, r.$from.pos, r.$to.pos, t, i)) || e.dispatch(i()),
        n.preventDefault());
    }
  }));
const Wr = Ht ? "metaKey" : "ctrlKey";
Or.mousedown = (e, t) => {
  let n = t;
  ...
  (i - e.input.lastClick.time < 500 &&
    ...
    (e.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: o, button: n.button }));
  let s = e.posAtCoords(Ir(n));
  s &&
    ("singleClick" == o
      ? (e.input.mouseDown && e.input.mouseDown.done(), (e.input.mouseDown = new Jr(e, s, n, !!r)))
      : ("doubleClick" == o ? Vr : Fr)(e, s.pos, s.inside, n)
        ? n.preventDefault()
        : Er(e, "pointer"));
};
class Jr {
  constructor(e, t, n, r) {
    ...
    (((0 == n.button && i.type.spec.draggable && !1 !== i.type.spec.selectable) ||
      (a instanceof ot && a.from <= o && a.to > o)) &&
      (this.mightDrag = {
        node: i,
        pos: o,
    ...
    (this.view.root.removeEventListener("mouseup", this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => _n(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let t = this.pos;
    (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Ir(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !t
        ? Er(this.view, "pointer")
        : Br(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : 0 == e.button &&
              (this.flushed ||
                (_t && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (qt &&
            ...
            ? (Pr(this.view, Qe.near(this.view.state.doc.resolve(t.pos))), e.preventDefault())
            : Er(this.view, "pointer"));
  }
  move(e) {
    (this.updateAllowDefault(e), Er(this.view, "pointer"), 0 == e.buttons && this.done());
  }
...
function qr(e, t) {
  return (
    !!e.composing ||
    (!!(_t && Math.abs(t.timeStamp - e.input.compositionEndedAt) < 500) && ((e.input.compositionEndedAt = -2e8), !0))
  );
}
((Or.touchstart = (e) => {
  ((e.input.lastTouch = Date.now()), Lr(e), Er(e, "pointer"));
}),
  (Or.touchmove = (e) => {
    ((e.input.lastTouch = Date.now()), Er(e, "pointer"));
  }),
  (Or.contextmenu = (e) => Lr(e)));
const jr = Ut ? 5e3 : -1;
function _r(e, t) {
  (clearTimeout(e.input.composingTimeout), t > -1 && (e.input.composingTimeout = setTimeout(() => Yr(e), t)));
}
function Kr(e) {
  for (
    e.composing &&
  ...
  let n = (function (e, t) {
      for (;;) {
        ...
        if (1 == e.nodeType && t > 0) {
          ...
          t = Dt((e = e.childNodes[t - 1]));
        } else {
          if (!e.parentNode || Et(e)) return null;
...
function Yr(e, t = !1) {
  if (!(Ut && e.domObserver.flushingSoon >= 0)) {
    if ((e.domObserver.forceFlush(), Kr(e), t || (e.docView && e.docView.dirty))) {
      let n = qn(e),
        r = e.state.selection;
      return (
        n && !n.eq(r)
...
((Nr.compositionstart = Nr.compositionupdate =
  (e) => {
    if (!e.composing) {
      e.domObserver.flush();
      let { state: t } = e,
        n = t.selection.$to;
      if (
        t.selection instanceof rt &&
        (t.storedMarks ||
          (!n.textOffset && n.parentOffset && n.nodeBefore.marks.some((e) => !1 === e.type.spec.inclusive)) ||
          (qt &&
            Yt &&
            (function (e) {
              let { focusNode: t, focusOffset: n } = e.domSelectionRange();
              if (!t || 1 != t.nodeType || n >= t.childNodes.length) return !1;
              let r = t.childNodes[n];
              return 1 == r.nodeType && "false" == r.contentEditable;
            })(e)))
      )
        ((e.markCursor = e.state.storedMarks || n.marks()), Yr(e, !0), (e.markCursor = null));
      else if (
        (Yr(e, !t.selection.empty),
        Wt && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
      ) {
        let t = e.domSelectionRange();
...
const Ur = (Ft && Lt < 15) || (Kt && Zt < 604);
function Gr(e, t, n, r, i) {
  let o = mr(e, t, n, r, e.state.selection.$from);
  if (e.someProp("handlePaste", (t) => t(e, i, o || c.empty))) return !0;
  if (!o) return !1;
  let s = (function (e) {
...
((Or.copy = Nr.cut =
  (e, t) => {
    let n = t,
      ...
      i = "cut" == n.type;
    if (r.empty) return;
    let o = Ur ? null : n.clipboardData,
      s = r.content(),
      { dom: l, text: a } = fr(e, s);
    (o
      ? (n.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a))
      : (function (e, t) {
  ...
  (Nr.paste = (e, t) => {
    let n = t;
    if (e.composing && !Ut) return;
    let r = Ur ? null : n.clipboardData,
      i = e.input.shiftKey && 45 != e.input.lastKeyCode;
    r && Gr(e, Zr(r), r.getData("text/html"), i, n)
      ? n.preventDefault()
      : (function (e, t) {
          if (!e.dom.parentNode) return;
          ...
          setTimeout(() => {
            (e.focus(),
              ...
              n ? Gr(e, r.value, null, i, t) : Gr(e, r.textContent, r.innerHTML, i, t));
          }, 50);
        })(e, n);
  }));
class Xr {
...
const Qr = Ht ? "altKey" : "ctrlKey";
function ei(e, t) {
  let n = e.someProp("dragCopies", (e) => !e(t));
  return null != n ? n : !t[Qr];
}
((Or.dragstart = (e, t) => {
  let n = t,
    r = e.input.mouseDown;
  ...
  let i,
    o = e.state.selection,
    s = o.empty ? null : e.posAtCoords(Ir(n));
  if (s && s.pos >= o.from && s.pos <= (o instanceof ot ? o.to - 1 : o.to));
  else if (r && r.mightDrag) i = ot.create(e.state.doc, r.mightDrag.pos);
  else if (n.target && 1 == n.target.nodeType) {
    let t = e.docView.nearestDesc(n.target, !0);
    t && t.node.type.spec.draggable && t != e.docView && (i = ot.create(e.state.doc, t.posBefore));
  }
  let l = (i || e.state.selection).content(),
    { dom: a, text: h, slice: c } = fr(e, l);
  ((!n.dataTransfer.files.length || !qt || jt > 120) && n.dataTransfer.clearData(),
    n.dataTransfer.setData(Ur ? "Text" : "text/html", a.innerHTML),
    (n.dataTransfer.effectAllowed = "copyMove"),
    Ur || n.dataTransfer.setData("text/plain", h),
    (e.dragging = new Xr(c, ei(e, n), i)));
}),
  (Or.dragend = (e) => {
    let t = e.dragging;
    window.setTimeout(() => {
  ...
  (Nr.dragover = Nr.dragenter = (e, t) => t.preventDefault()),
  (Nr.drop = (e, t) => {
    try {
      !(function (e, t, n) {
        if (!t.dataTransfer) return;
        let r = e.posAtCoords(Ir(t));
        if (!r) return;
        ...
        o
          ...
          : (o = mr(e, Zr(t.dataTransfer), Ur ? null : t.dataTransfer.getData("text/html"), !1, i));
        let s = !(!n || !ei(e, t));
        if (e.someProp("handleDrop", (n) => n(e, t, o || c.empty, s))) return void t.preventDefault();
        if (!o) return;
        t.preventDefault();
        let l = o
          ? (function (e, t, n) {
              ...
              for (let o = 1; o <= (0 == n.openStart && n.size ? 2 : 1); o++)
                for (let e = r.depth; e >= 0; e--) {
                  let t = e == r.depth ? 0 : r.pos <= (r.start(e + 1) + r.end(e + 1)) / 2 ? -1 : 1,
                    ...
                    s = r.node(e),
                    l = !1;
                  if (1 == o) l = s.canReplace(n, n, i);
                  else {
                    let e = s.contentMatchAt(n).findWrapping(i.firstChild.type);
                    l = e && s.canReplaceWith(n, n, e[0]);
                  }
                  if (l) return 0 == t ? r.pos : t < 0 ? r.before(e + 1) : r.after(e + 1);
                }
              return null;
            })(e.state.doc, i.pos, o)
          : i.pos;
        ...
        if (s) {
          let { node: e } = n;
          e ? e.replace(a) : a.deleteSelection();
        }
        let h = a.mapping.map(l),
          d = 0 == o.openStart && 0 == o.openEnd && 1 == o.content.childCount,
          p = a.doc;
        d ? a.replaceRangeWith(h, h, o.content.firstChild) : a.replaceRange(h, h, o);
        if (a.doc.eq(p)) return;
        let u = a.doc.resolve(h);
        if (d && ot.isSelectable(o.content.firstChild) && u.nodeAfter && u.nodeAfter.sameMarkup(o.content.firstChild))
          a.setSelection(new ot(u));
        else {
          let t = a.mapping.map(l);
          (a.mapping.maps[a.mapping.maps.length - 1].forEach((e, n, r, i) => (t = i)),
            a.setSelection(Xn(e, u, a.doc.resolve(t))));
        }
  ...
  (Or.focus = (e) => {
    ((e.input.lastFocus = Date.now()),
      e.focused ||
        ...
        (e.focused = !0),
        setTimeout(() => {
          e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && _n(e);
        }, 20)));
  }),
  (Or.blur = (e, t) => {
    let n = t;
...
class ni {
  constructor(e, t) {
    ((this.toDOM = e), (this.spec = t || li), (this.side = this.spec.side || 0));
  }
  map(e, t, n, r) {
    let { pos: i, deleted: o } = e.mapResult(t.from + r, this.side < 0 ? -1 : 1);
    return o ? null : new oi(i - n, i - n, this);
  }
  valid() {
    return !0;
  }
  eq(e) {
    return (
      this == e ||
      (e instanceof ni &&
        ((this.spec.key && this.spec.key == e.spec.key) || (this.toDOM == e.toDOM && ti(this.spec, e.spec))))
    );
  }
  destroy(e) {
...
class ri {
  constructor(e, t) {
    ((this.attrs = e), (this.spec = t || li));
  }
  map(e, t, n, r) {
    let i = e.map(t.from + r, this.spec.inclusiveStart ? -1 : 1) - n,
      o = e.map(t.to + r, this.spec.inclusiveEnd ? 1 : -1) - n;
    return i >= o ? null : new oi(i, o, this);
  }
  valid(e, t) {
    return t.from < t.to;
  }
  eq(e) {
    return this == e || (e instanceof ri && ti(this.attrs, e.attrs) && ti(this.spec, e.spec));
  }
  static is(e) {
...
class ii {
  ...
  map(e, t, n, r) {
    ...
    return o.deleted || o.pos <= i.pos ? null : new oi(i.pos - n, o.pos - n, this);
  }
  valid(e, t) {
    let n,
  ...
  eq(e) {
    return this == e || (e instanceof ii && ti(this.attrs, e.attrs) && ti(this.spec, e.spec));
  }
  destroy() {}
}
class oi {
  ...
  static widget(e, t, n) {
    return new oi(e, e, new ni(t, n));
  }
  static inline(e, t, n, r) {
    return new oi(e, t, new ri(n, r));
  }
  static node(e, t, n, r) {
    return new oi(e, t, new ii(n, r));
  }
  get spec() {
...
class ai {
  constructor(e, t) {
    ((this.local = e.length ? e : si), (this.children = t.length ? t : si));
  }
  static create(e, t) {
    return t.length ? fi(t, e, 0, li) : hi;
  }
  find(e, t, n) {
    let r = [];
  ...
  findInner(e, t, n, r, i) {
    for (let o = 0; o < this.local.length; o++) {
      let s = this.local[o];
      s.from <= t && s.to >= e && (!i || i(s.spec)) && n.push(s.copy(s.from + r, s.to + r));
    }
  ...
  map(e, t, n) {
    return this == hi || 0 == e.maps.length ? this : this.mapInner(e, t, 0, 0, n || li);
  }
  mapInner(e, t, n, r, i) {
    let o;
    for (let s = 0; s < this.local.length; s++) {
      let l = this.local[s].map(e, n, r);
      l && l.type.valid(t, l) ? (o || (o = [])).push(l) : i.onRemove && i.onRemove(this.local[s].spec);
    }
    return this.children.length
      ? (function (e, t, n, r, i, o, s) {
          let l = e.slice();
          for (let h = 0, c = o; h < n.maps.length; h++) {
            let e = 0;
            (n.maps[h].forEach((t, n, r, i) => {
              let o = i - r - (n - t);
              for (let s = 0; s < l.length; s += 3) {
                let r = l[s + 1];
                if (r < 0 || t > r + c - e) continue;
                let i = l[s] + c - e;
                n >= i ? (l[s + 1] = t <= i ? -2 : -1) : t >= c && o && ((l[s] += o), (l[s + 1] += o));
              }
              e += o;
            }),
              (c = n.maps[h].map(c, -1)));
          ...
          for (let h = 0; h < l.length; h += 3)
            if (l[h + 1] < 0) {
              ...
              let d = n.map(e[h + 1] + o, -1) - i,
                { index: p, offset: u } = r.content.findIndex(c),
                f = r.maybeChild(p);
              if (f && u == c && u + f.nodeSize == d) {
                let r = l[h + 2].mapInner(n, f, t + 1, e[h] + o + 1, s);
                r != hi ? ((l[h] = c), (l[h + 1] = d), (l[h + 2] = r)) : ((l[h + 1] = -2), (a = !0));
              } else a = !0;
            }
          if (a) {
            let a = (function (e, t, n, r, i, o, s) {
                ...
                for (let a = 0; a < e.length; a += 3) -1 == e[a + 1] && l(e[a + 2], t[a] + o + 1);
                return n;
              })(l, e, t, n, i, o, s),
              h = fi(a, r, 0, s);
            t = h.local;
            ...
            for (let e = 0, t = 0; e < h.children.length; e += 3) {
              ...
              l.splice(t, 0, h.children[e], h.children[e + 1], h.children[e + 2]);
            }
          }
          return new ai(t.sort(mi), l);
  ...
  add(e, t) {
    return t.length ? (this == hi ? ai.create(e, t) : this.addInner(e, t, 0)) : this;
  }
  addInner(e, t, n) {
    let r,
      i = 0;
    e.forEach((e, o) => {
      ...
      if ((s = pi(t, e, l))) {
        ...
        (r[i] == o
          ...
          : r.splice(i, 0, o, o + e.nodeSize, fi(s, e, l + 1, li)),
          (i += 3));
      }
    });
    let o = di(i ? ui(t) : t, -n);
    for (let s = 0; s < o.length; s++) o[s].type.valid(e, o[s]) || o.splice(s--, 1);
    return new ai(o.length ? this.local.concat(o).sort(mi) : this.local, r || this.children);
  }
  remove(e) {
    return 0 == e.length || this == hi ? this : this.removeInner(e, 0);
  }
  removeInner(e, t) {
    let n = this.children,
      r = this.local;
    for (let i = 0; i < n.length; i += 3) {
      ...
      for (let t, n = 0; n < e.length; n++)
        (t = e[n]) && t.from > o && t.to < s && ((e[n] = null), (r || (r = [])).push(t));
      if (!r) continue;
      n == this.children && (n = this.children.slice());
      let l = n[i + 2].removeInner(r, o + 1);
      l != hi ? (n[i + 2] = l) : (n.splice(i, 3), (i -= 3));
    }
    if (r.length)
      for (let i, o = 0; o < e.length; o++)
        if ((i = e[o]))
          for (let e = 0; e < r.length; e++)
            r[e].eq(i, t) && (r == this.local && (r = this.local.slice()), r.splice(e--, 1));
    return n == this.children && r == this.local ? this : r.length || n.length ? new ai(r, n) : hi;
  }
  forChild(e, t) {
    if (this == hi) return this;
    if (t.isLeaf) return ai.empty;
    let n, r;
    ...
    for (let s = 0; s < this.local.length; s++) {
      let e = this.local[s];
      if (e.from < o && e.to > i && e.type instanceof ri) {
    ...
    if (r) {
      let e = new ai(r.sort(mi), si);
      return n ? new ci([e, n]) : e;
    }
    return n || hi;
  }
  eq(e) {
    if (this == e) return !0;
    if (!(e instanceof ai) || this.local.length != e.local.length || this.children.length != e.children.length)
      return !1;
  ...
  localsInner(e) {
    if (this == hi) return si;
    if (e.inlineContent || !this.local.some(ri.is)) return this.local;
    let t = [];
    for (let n = 0; n < this.local.length; n++) this.local[n].type instanceof ri || t.push(this.local[n]);
    return t;
  }
  forEachSet(e) {
    e(this);
...
((ai.empty = new ai([], [])), (ai.removeOverlap = gi));
const hi = ai.empty;
class ci {
  constructor(e) {
    this.members = e;
  ...
  map(e, t) {
    const n = this.members.map((n) => n.map(e, t, li));
    return ci.from(n);
  }
  forChild(e, t) {
    if (t.isLeaf) return ai.empty;
    ...
    for (let r = 0; r < this.members.length; r++) {
      ...
      i != hi && (i instanceof ci ? (n = n.concat(i.members)) : n.push(i));
    }
    return ci.from(n);
  }
  eq(e) {
    if (!(e instanceof ci) || e.members.length != this.members.length) return !1;
  ...
  static from(e) {
    switch (e.length) {
      ...
      default:
        return new ci(
          e.every((e) => e instanceof ai) ? e : e.reduce((e, t) => e.concat(t instanceof ai ? t : t.members), []),
        );
    }
  }
  forEachSet(e) {
...
function di(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    let i = e[r];
    n.push(new oi(i.from + t, i.to + t, i.type));
  }
  return n;
}
function pi(e, t, n) {
  ...
  for (let o, s = 0; s < e.length; s++)
    (o = e[s]) && o.from > n && o.to < r && ((i || (i = [])).push(o), (e[s] = null));
  return i;
}
function ui(e) {
  let t = [];
...
function fi(e, t, n, r) {
  ...
  t.forEach((t, s) => {
    ...
    if (l) {
      o = !0;
      let e = fi(l, t, n + s + 1, r);
      e != hi && i.push(s, s + t.nodeSize, e);
    }
  });
  let s = di(o ? ui(e) : e, -n).sort(mi);
  for (let l = 0; l < s.length; l++)
    s[l].type.valid(t, s[l]) || (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
  return s.length || i.length ? new ai(s, i) : hi;
}
function mi(e, t) {
  ...
  for (let n = 0; n < t.length - 1; n++) {
    ...
    if (r.from != r.to)
      for (let i = n + 1; i < t.length; i++) {
        let o = t[i];
        if (o.from != r.from) {
          o.from < r.to && (t == e && (t = e.slice()), (t[n] = r.copy(r.from, o.from)), yi(t, i, r.copy(o.from, r.to)));
          break;
        }
        o.to != r.to && (t == e && (t = e.slice()), (t[i] = o.copy(o.from, r.to)), yi(t, i + 1, o.copy(r.to, o.to)));
      }
  }
  return t;
}
function yi(e, t, n) {
  for (; t < e.length && mi(n, e[t]) > 0; ) t++;
  e.splice(t, 0, n);
}
function wi(e) {
  let t = [];
  return (
    ...
    e.cursorWrapper && t.push(ai.create(e.state.doc, [e.cursorWrapper.deco])),
    ci.from(t)
  );
}
const vi = {
...
class Si {
      ...
      (this.observer =
        ...
        new window.MutationObserver((t) => {
          ...
          t.some(
            ...
            ? this.flushSoon()
            : _t && e.composing && t.some((e) => "childList" == e.type && "TR" == e.target.nodeName)
  ...
  start() {
    (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, vi)),
  ...
  onSelectionChange() {
    if (Qn(this.view)) {
      if (this.suppressingSelectionUpdates) return _n(this.view);
      if (Ft && Lt <= 11 && !this.view.state.selection.empty) {
        let e = this.view.domSelectionRange();
        if (e.focusNode && Ot(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)) return this.flushSoon();
      }
      this.flush();
    }
  }
  ...
  ignoreSelectionChange(e) {
    ...
    let t,
      n = new Set();
    for (let i = e.focusNode; i; i = kt(i)) n.add(i);
    for (let i = e.anchorNode; i; i = kt(i))
      if (n.has(i)) {
        t = i;
        break;
      }
  ...
  flush() {
    ...
    t.length && (this.queue = []);
    let n = e.domSelectionRange(),
      r = !this.suppressingSelectionUpdates && !this.currentSelection.eq(n) && Qn(e) && !this.ignoreSelectionChange(n),
      i = -1,
      o = -1,
      s = !1,
      l = [];
    if (e.editable)
      for (let h = 0; h < t.length; h++) {
        let e = this.registerMutation(t[h], l);
        e &&
          ((i = i < 0 ? e.from : Math.min(e.from, i)), (o = o < 0 ? e.to : Math.max(e.to, o)), e.typeOver && (s = !0));
      }
    if (!l.some((e) => "BR" == e.nodeName) || (8 != e.input.lastKeyCode && 46 != e.input.lastKeyCode)) {
      if (Wt && l.length) {
        ...
        if (2 == t.length) {
          ...
          for (let r of t) {
            let t = r.parentNode;
            !t || "LI" != t.nodeName || (n && Oi(e, n) == t) || r.remove();
          }
        }
      }
    } else
      for (let h of l)
        if ("BR" == h.nodeName && h.parentNode) {
          let e = h.nextSibling;
          for (; e && 1 == e.nodeType; ) {
    ...
    At(n) &&
    (a = qn(e)) &&
    a.eq(Qe.near(e.state.doc.resolve(0), 1))
      ? ((e.input.lastFocus = 0), _n(e), this.currentSelection.set(n), e.scrollToSelection())
      : (i > -1 || r) &&
        (i > -1 &&
          (e.docView.markDirty(i, o),
          (function (e) {
            if (ki.has(e)) return;
            if (
              (ki.set(e, null), -1 !== ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(e.dom).whiteSpace))
            ) {
              if (((e.requiresGeckoHackNode = Wt), Mi)) return;
              (console.warn(
        ...
        e.input.badSafariComposition &&
          ((e.input.badSafariComposition = !1),
          (function (e, t) {
            var n;
            let { focusNode: r, focusOffset: i } = e.domSelectionRange();
            for (let o of t)
              if ("TR" == (null === (n = o.parentNode) || void 0 === n ? void 0 : n.nodeName)) {
                let t = o.nextSibling;
                for (; t && "TD" != t.nodeName && "TH" != t.nodeName; ) t = t.nextSibling;
                if (t) {
                  let n = t;
                  for (;;) {
                    let e = n.firstChild;
                    if (!e || 1 != e.nodeType || "false" == e.contentEditable || /^(BR|IMG)$/.test(e.nodeName)) break;
                    n = e;
                  }
                  (n.insertBefore(o, n.firstChild), r == o && e.domSelection().collapse(o, i));
                } else o.parentNode.removeChild(o);
              }
          })(e, l)),
        this.handleDOMChange(i, o, s, l),
        e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || _n(e),
  ...
  registerMutation(e, t) {
    ...
    if ("childList" == e.type) {
      ...
      let r = e.previousSibling,
        i = e.nextSibling;
      if (Ft && Lt <= 11 && e.addedNodes.length)
        for (let t = 0; t < e.addedNodes.length; t++) {
          ...
          ((!n || Array.prototype.indexOf.call(e.addedNodes, n) < 0) && (r = n),
            (!o || Array.prototype.indexOf.call(e.addedNodes, o) < 0) && (i = o));
        }
      let o = r && r.parentNode == e.target ? St(r) + 1 : 0,
        s = n.localPosFromDOM(e.target, o, -1),
        l = i && i.parentNode == e.target ? St(i) : e.target.childNodes.length;
      return { from: s, to: n.localPosFromDOM(e.target, l, 1) };
    }
...
function Ci(e, t) {
  ...
  return (
    Ot(s.node, s.offset, i, o) && ([n, r, i, o] = [i, o, n, r]),
...
function Ni(e) {
  ...
  if ("BR" == e.nodeName && e.parentNode) {
    if (_t && /^(ul|ol)$/i.test(e.parentNode.nodeName)) {
      let e = document.createElement("div");
      return (e.appendChild(document.createElement("li")), { skip: e });
    }
    if (e.parentNode.lastChild == e || (_t && /^(tr|table)$/i.test(e.parentNode.nodeName))) return { ignore: !0 };
...
function Di(e, t, n, r, o) {
  ...
  if (((e.input.compositionPendingChanges = 0), t < 0)) {
    ...
    if (n && !e.state.selection.eq(n)) {
      if (
        ...
        e.someProp("handleKeyDown", (t) => t(e, $t(13, "Enter")))
      )
        return;
      let r = e.state.tr.setSelection(n);
      ("pointer" == t ? r.setMeta("pointer", !0) : "key" == t && r.scrollIntoView(),
        s && r.setMeta("composition", s),
        e.dispatch(r));
    }
    return;
  }
  ...
  let h,
    ...
    p = (function (e, t, n) {
      let r,
        { node: i, fromOffset: o, toOffset: s, from: l, to: a } = e.docView.parseRange(t, n),
        h = e.domSelectionRange(),
        c = h.anchorNode;
      if (
        (c &&
          e.dom.contains(1 == c.nodeType ? c : c.parentNode) &&
          ((r = [{ node: c, offset: h.anchorOffset }]), At(h) || r.push({ node: h.focusNode, offset: h.focusOffset })),
        qt && 8 === e.input.lastKeyCode)
      )
        for (let g = s; g > o; g--) {
          let e = i.childNodes[g - 1],
            t = e.pmViewDesc;
          if ("BR" == e.nodeName && !t) {
            s = g;
            break;
      ...
      let d = e.state.doc,
        p = e.someProp("domParser") || U.fromSchema(e.state.schema),
        u = d.resolve(l),
        f = null,
        m = p.parse(i, {
          topNode: u.parent,
      ...
      if (r && null != r[0].pos) {
        let e = r[0].pos,
          t = r[1] && r[1].pos;
        (null == t && (t = e), (f = { anchor: e + l, head: t + l }));
      }
      return { doc: m, sel: f, from: l, to: a };
    })(e, t, n),
    u = e.state.doc,
    f = u.slice(p.from, p.to);
  (8 === e.input.lastKeyCode && Date.now() - 100 < e.input.lastKeyCodeTime
    ? ((h = e.state.selection.to), (c = "end"))
    : ((h = e.state.selection.from), (c = "start")),
    (e.input.lastKeyCode = null));
  let m = (function (e, t, n, r, i) {
    ...
    if (s < o && e.size < t.size) {
      let e = r <= o && r >= s ? o - r : 0;
      ((o -= e), o && o < t.size && $i(t.textBetween(o - 1, o + 1)) && (o += e ? 1 : -1), (l = o + (l - s)), (s = o));
    } else if (l < o) {
      let t = r <= o && r >= l ? o - r : 0;
      ((o -= t), o && o < e.size && $i(e.textBetween(o - 1, o + 1)) && (o += t ? 1 : -1), (s = o + (s - l)), (l = o));
    }
    return { start: o, endA: s, endB: l };
  })(f.content, p.doc.content, p.from, h, c);
  if (
    (m && e.input.domChangeCount++,
    ((Kt && e.input.lastIOSEnter > Date.now() - 225) || Ut) &&
      o.some((e) => 1 == e.nodeType && !Ti.test(e.nodeName)) &&
      (!m || m.endA >= m.endB) &&
      e.someProp("handleKeyDown", (t) => t(e, $t(13, "Enter"))))
  )
  ...
  if (!m) {
    if (
      !(r && d instanceof rt && !d.empty && d.$head.sameParent(d.$anchor)) ||
      e.composing ||
      (p.sel && p.sel.anchor != p.sel.head)
    ) {
      if (p.sel) {
        let t = Ei(e, e.state.doc, p.sel);
    ...
    m = { start: d.from, endA: d.to, endB: d.to };
  }
  (e.state.selection.from < e.state.selection.to &&
    m.start == m.endB &&
    e.state.selection instanceof rt &&
    (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= p.from
    ...
    Ft &&
      ...
      m.endA == m.start &&
      m.start > p.from &&
      "  " == p.doc.textBetween(m.start - p.from - 1, m.start - p.from + 1) &&
      (m.start--, m.endA--, m.endB--));
  let g = p.doc.resolveNoCache(m.start - p.from),
    y = p.doc.resolveNoCache(m.endB - p.from),
    w = u.resolve(m.start),
    v = g.sameParent(y) && g.parent.inlineContent && w.end() >= m.endA;
  if (
    ((Kt &&
      e.input.lastIOSEnter > Date.now() - 225 &&
      (!v || o.some((e) => "DIV" == e.nodeName || "P" == e.nodeName))) ||
      (!v &&
        g.pos < p.doc.content.size &&
        (!g.sameParent(y) || !g.parent.inlineContent) &&
        g.pos < y.pos &&
        !/\S/.test(p.doc.textBetween(g.pos, y.pos, "", "")))) &&
    e.someProp("handleKeyDown", (t) => t(e, $t(13, "Enter")))
  )
    return void (e.input.lastIOSEnter = 0);
  if (
    ...
    (function (e, t, n, r, i) {
      if (n - t <= i.pos - r.pos || Ai(r, !0, !1) < i.pos) return !1;
      let o = e.resolve(t);
      ...
      let s = e.resolve(Ai(o, !0, !0));
      return (
        !(!s.parent.isTextblock || s.pos > n || Ai(s, !0, !1) < n) &&
        r.parent.content.cut(r.parentOffset).eq(s.parent.content)
      );
    })(u, m.start, m.endA, g, y) &&
    e.someProp("handleKeyDown", (t) => t(e, $t(8, "Backspace")))
  )
    return void (Ut && qt && e.domObserver.suppressSelectionUpdates());
  (qt && m.endB == m.start && (e.input.lastChromeDelete = Date.now()),
    Ut &&
      !v &&
      g.start() != y.start() &&
      0 == y.parentOffset &&
  ...
  let x,
    ...
    S = m.endA,
    k = (t) => {
      let n = t || e.state.tr.replace(b, S, p.doc.slice(m.start - p.from, m.endB - p.from));
      if (p.sel) {
        let t = Ei(e, n.doc, p.sel);
        t &&
          !(
            (qt &&
              e.composing &&
              ...
              (t.head == b || t.head == n.mapping.map(S) - 1)) ||
            (Ft && t.empty && t.head == b)
          ) &&
          n.setSelection(t);
      }
  ...
  if (v)
    if (g.pos == y.pos) {
      Ft && Lt <= 11 && 0 == g.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => _n(e), 20));
      let t = k(e.state.tr.delete(b, S)),
      ...
      (x = (function (e, t) {
        ...
        for (let i = 0; i < s.length; i++) h = s[i].removeFromSet(h);
        if (1 == a.length && 0 == h.length) ((r = a[0]), (n = "add"), (o = (e) => e.mark(r.addToSet(e.marks))));
        else {
          if (0 != a.length || 1 != h.length) return null;
          ((r = h[0]), (n = "remove"), (o = (e) => e.mark(r.removeFromSet(e.marks))));
        }
        let c = [];
        for (let i = 0; i < t.childCount; i++) c.push(o(t.child(i)));
        if (i.from(c).eq(e)) return { mark: r, type: n };
      })(
      ...
      let t = k(e.state.tr);
      ("add" == x.type ? t.addMark(b, S, x.mark) : t.removeMark(b, S, x.mark), e.dispatch(t));
    } else if (g.parent.child(g.index()).isText && g.index() == y.index() - (y.textOffset ? 0 : 1)) {
      let t = g.parent.textBetween(g.parentOffset, y.parentOffset),
        n = () => k(e.state.tr.insertText(t, b, S));
      e.someProp("handleTextInput", (r) => r(e, b, S, t, n)) || e.dispatch(n());
    } else e.dispatch(k());
  else e.dispatch(k());
}
function Ei(e, t, n) {
...
class Ri {
  constructor(e, t) {
    ((this._root = null),
      ...
      (this.editable = Pi(this)),
      zi(this),
      (this.nodeViews = Bi(this)),
      (this.docView = Nn(this.state.doc, Ii(this), wi(this), this.dom, this)),
      (this.domObserver = new Si(this, (e, t, n, r) => Di(this, e, t, n, r))),
        ...
        for (let t in Or) {
          ...
          e.dom.addEventListener(
            ...
            (e.input.eventHandlers[t] = (t) => {
              !Rr(e, t) || $r(e, t) || (!e.editable && t.type in Nr) || n(e, t);
            }),
            Tr[t] ? { passive: !0 } : void 0,
          );
        }
        (_t && e.dom.addEventListener("input", () => null), Ar(e));
      })(this),
  ...
  updateStateInner(e, t) {
    ...
    let r = this.state,
      i = !1,
      o = !1;
    (e.storedMarks && this.composing && (Kr(this), (o = !0)), (this.state = e));
    ...
    ((s || t.handleDOMEvents != this._props.handleDOMEvents) && Ar(this), (this.editable = Pi(this)), zi(this));
    let l = wi(this),
      a = Ii(this),
      h =
        r.plugins == e.plugins || r.doc.eq(e.doc)
          ? e.scrollToSelection > r.scrollToSelection
            ...
            : "preserve"
          : "reset",
      c = i || !this.docView.matchesNode(e.doc, a, l);
    ...
    let d =
      ...
      (function (e) {
        ...
        return { refDOM: t, refTop: n, stack: nn(e.dom) };
      })(this);
    if (o) {
      ...
      if (c) {
        let n = qt ? (this.trackWrites = this.domSelectionRange().focusNode) : null;
        (this.composing && (this.input.compositionNode = Hr(this)),
          (!i && this.docView.update(e.doc, a, l, this)) ||
            (this.docView.updateOuterDeco(a), this.docView.destroy(), (this.docView = Nn(e.doc, a, l, this.dom, this))),
      ...
      !(
        ...
        (function (e) {
          ...
          return Ot(t.node, t.offset, n.anchorNode, n.anchorOffset);
        })(this)
      )
        ? _n(this, t)
        : (Gn(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start());
    }
  ...
  scrollToSelection() {
    ...
    if (e && this.dom.contains(1 == e.nodeType ? e : e.parentNode))
      ...
      else if (this.state.selection instanceof ot) {
        let t = this.docView.domAfterPos(this.state.selection.from);
        1 == t.nodeType && tn(this, t.getBoundingClientRect(), e);
      } else tn(this, this.coordsAtPos(this.state.selection.head, 1), e);
    else;
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Xr(e.slice, e.move, r < 0 ? void 0 : ot.create(this.state.doc, r));
  }
  someProp(e, t) {
    let n,
    ...
    for (let o = 0; o < this.directPlugins.length; o++) {
      let r = this.directPlugins[o].props[e];
      if (null != r && (n = t ? t(r) : r)) return n;
    }
  ...
  endOfTextblock(e, t) {
    return bn(this, t || this.state, e);
  }
  pasteHTML(e, t) {
    return Gr(this, "", e, !1, t || new ClipboardEvent("paste"));
  }
  pasteText(e, t) {
    return Gr(this, e, null, !0, t || new ClipboardEvent("paste"));
  }
  ...
  destroy() {
    this.docView &&
      ...
      this.mounted
        ? (this.docView.update(this.state.doc, [], wi(this), this), (this.dom.textContent = ""))
  ...
  dispatchEvent(e) {
    return (function (e, t) {
      $r(e, t) || !Or[t.type] || (!e.editable && t.type in Nr) || Or[t.type](e, t);
    })(this, e);
  }
  domSelectionRange() {
...
function Ii(e) {
  ...
  return (
    ...
    [oi.node(0, e.state.doc.content.size, t)]
  );
}
function zi(e) {
  if (e.markCursor) {
    ...
    ((t.className = "ProseMirror-separator"),
      ...
      t.setAttribute("alt", ""),
      (e.cursorWrapper = { dom: t, deco: oi.widget(e.state.selection.from, t, { raw: !0, marks: e.markCursor }) }));
...
Ri.prototype.dispatch = function (e) {
...
for (
  var Fi = {
    ...
    Wi = "undefined" != typeof navigator && /Mac/.test(navigator.platform),
    Ji = "undefined" != typeof navigator && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent),
    qi = 0;
  qi < 10;
  qi++
)
  Fi[48 + qi] = Fi[96 + qi] = String(qi);
for (qi = 1; qi <= 24; qi++) Fi[qi + 111] = "F" + qi;
for (qi = 65; qi <= 90; qi++) ((Fi[qi] = String.fromCharCode(qi + 32)), (Li[qi] = String.fromCharCode(qi)));
for (var ji in Fi) Li.hasOwnProperty(ji) || (Li[ji] = Fi[ji]);
const _i = "undefined" != typeof navigator && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  Ki = "undefined" != typeof navigator && /Win/.test(navigator.platform);
function Hi(e) {
  let t,
    n,
    r,
  ...
  for (let l = 0; l < o.length - 1; l++) {
    ...
    else if (/^a(lt)?$/i.test(e)) t = !0;
    else if (/^(c|ctrl|control)$/i.test(e)) n = !0;
    else if (/^s(hift)?$/i.test(e)) r = !0;
    else {
...
function Ui(e) {
  return new wt({ props: { handleKeyDown: Gi(e) } });
}
function Gi(e) {
  let t = (function (e) {
    let t = Object.create(null);
    for (let n in e) t[Hi(n)] = e[n];
    return t;
  })(e);
  return function (e, n) {
    let r,
      i = (function (e) {
        var t =
          (!(
            (Wi && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
            (Ji && e.shiftKey && e.key && 1 == e.key.length) ||
            "Unidentified" == e.key
          ) &&
            e.key) ||
          (e.shiftKey ? Li : Fi)[e.keyCode] ||
          e.key ||
          "Unidentified";
        return (
          "Esc" == t && (t = "Escape"),
    ...
    if (1 == i.length && " " != i) {
      ...
      if ((n.altKey || n.metaKey || n.ctrlKey) && !(Ki && n.ctrlKey && n.altKey) && (r = Fi[n.keyCode]) && r != i) {
        let i = t[Yi(r, n)];
...
const Zi = (e, t) => !e.selection.empty && (t && t(e.tr.deleteSelection().scrollIntoView()), !0);
function Xi(e, t, n = !1) {
...
const ro = (e, t) => {
  ...
  let i = n.node(-1),
    o = n.indexAfter(-1),
    s = no(i.contentMatchAt(o));
  if (!s || !i.canReplaceWith(o, o, s)) return !1;
  if (t) {
    let r = n.after(),
      i = e.tr.replaceWith(r, r, s.createAndFill());
    (i.setSelection(Qe.near(i.doc.resolve(r), 1)), t(i.scrollIntoView()));
  }
  return !0;
};
const io = (e, t) => {
  let { $from: n, $to: r } = e.selection;
  if (e.selection instanceof ot && e.selection.node.isBlock)
    return !(!n.parentOffset || !ze(e.doc, n.pos) || (t && t(e.tr.split(n.pos).scrollIntoView()), 0));
  if (!n.depth) return !1;
  let i,
    o,
    s = [],
  ...
  for (let p = n.depth; ; p--) {
    if (n.node(p).isBlock) {
      ((l = n.end(p) == n.pos + (n.depth - p)),
        (a = n.start(p) == n.pos - (n.depth - p)),
        (o = no(n.node(p - 1).contentMatchAt(n.indexAfter(p - 1)))),
        s.unshift(l && o ? { type: o } : null),
        (i = p));
      break;
    }
    if (1 == p) return !1;
  ...
  let h = e.tr;
  (e.selection instanceof rt || e.selection instanceof lt) && h.deleteSelection();
  let c = h.mapping.map(n.pos),
    d = ze(h.doc, c, s.length, s);
  if ((d || ((s[0] = o ? { type: o } : null), (d = ze(h.doc, c, s.length, s))), !d)) return !1;
  if ((h.split(c, s.length, s), !l && a && n.node(i).type != o)) {
    let e = h.mapping.map(n.before(i)),
      t = h.doc.resolve(e);
    o && n.node(i - 1).canReplaceWith(t.index(), t.index() + 1, o) && h.setNodeMarkup(h.mapping.map(n.before(i)), o);
  }
      ...
      return !(
        ...
        (!r.content.size && t.parent.canReplace(o - 1, o)
          ...
          : !t.parent.canReplace(o, o + 1) ||
            (!i.isTextblock && !Pe(e.doc, t.pos)) ||
            (n && n(e.tr.join(t.pos).scrollIntoView()), 0))
      );
    })(e, t, n)
  )
    return !0;
  let d = !h && t.parent.canReplace(t.index(), t.index() + 1);
  if (d && (o = (s = l.contentMatchAt(l.childCount)).findWrapping(a.type)) && s.matchType(o[0] || a.type).validEnd) {
    if (n) {
      let r = t.pos + a.nodeSize,
        s = i.empty;
      for (let e = o.length - 1; e >= 0; e--) s = i.from(o[e].create(null, s));
      s = i.from(l.copy(s));
      let h = e.tr.step(new Oe(t.pos - 1, r, t.pos, r, new c(s, 1, 0), o.length, !0)),
        d = h.doc.resolve(r + 2 * o.length);
      (d.nodeAfter && d.nodeAfter.type == l.type && Pe(h.doc, d.pos) && h.join(d.pos), n(h.scrollIntoView()));
    }
    return !0;
  }
  let p = a.type.spec.isolating || (r > 0 && h) ? null : Qe.findFrom(t, 1),
    u = p && p.$from.blockRange(p.$to),
    f = u && Ee(u);
  if (null != f && f >= t.depth) return (n && n(e.tr.lift(u, f).scrollIntoView()), !0);
  if (d && Xi(a, "start", !0) && Xi(l, "end")) {
    let r = l,
      o = [];
    ...
    if (r.canReplace(r.childCount, r.childCount, s.content)) {
      if (n) {
        let r = i.empty;
        for (let e = o.length - 1; e >= 0; e--) r = i.from(o[e].copy(r));
        n(
          e.tr
            .step(
              new Oe(
...
function so(e) {
  return function (t, n) {
    ...
    return !!i.node(o).isTextblock && (n && n(t.tr.setSelection(rt.create(t.doc, e < 0 ? i.start(o) : i.end(o)))), !0);
  };
}
const lo = so(-1),
  ao = so(1);
...
function po(e, t = null, n) {
  ...
  return function (n, s) {
    let { empty: l, $cursor: a, ranges: h } = n.selection;
    if (
      (l && !a) ||
      !(function (e, t, n, r) {
        for (let i = 0; i < t.length; i++) {
          ...
          if (
            (e.nodesBetween(o.pos, s.pos, (e, t) => {
              if (l || (!r && e.isAtom && e.isInline && t >= o.pos && t + e.nodeSize <= s.pos)) return !1;
      ...
      return !1;
    if (s)
      if (a) e.isInSet(n.storedMarks || a.marks()) ? s(n.tr.removeStoredMark(e)) : s(n.tr.addStoredMark(e.create(t)));
      else {
        let l,
          a = n.tr;
        (i ||
          (h = (function (e) {
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              (r.doc.nodesBetween(r.pos, i.pos, (e, n) => {
                if (e.isAtom && e.content.size && e.isInline && n >= r.pos && n + e.nodeSize <= i.pos)
                  return (
                    n + 1 > r.pos && t.push(new et(r, r.doc.resolve(n + 1))),
                    (r = r.doc.resolve(n + 1 + e.content.size)),
                    !1
                  );
              }),
                r.pos < i.pos && t.push(new et(r, i)));
            }
            return t;
          })(h)),
          (l = r
            ? !h.some((t) => n.doc.rangeHasMark(t.$from.pos, t.$to.pos, e))
            : !h.every((t) => {
                let n = !1;
                return (
                  a.doc.nodesBetween(t.$from.pos, t.$to.pos, (r, i, o) => {
                    if (n) return !1;
                    n =
                      !e.isInSet(r.marks) &&
                      !!o &&
                      o.type.allowsMarkType(e) &&
                      !(
                        r.isText &&
                        /^\s*$/.test(r.textBetween(Math.max(0, t.$from.pos - i), Math.min(r.nodeSize, t.$to.pos - i)))
                      );
                  }),
                  !n
                );
        ...
        for (let n = 0; n < h.length; n++) {
          ...
          if (l) {
            let n = r.pos,
              ...
              l = r.nodeAfter,
              h = i.nodeBefore,
              c = o && l && l.isText ? /^\s*/.exec(l.text)[0].length : 0,
              d = o && h && h.isText ? /\s*$/.exec(h.text)[0].length : 0;
            (n + c < s && ((n += c), (s -= d)), a.addMark(n, s, e.create(t)));
          } else a.removeMark(r.pos, i.pos, e);
        }
        s(a.scrollIntoView());
      }
    return !0;
...
let fo = uo(
    ...
    (e, t, n) => {
      ...
      let o = i.nodeBefore;
      if (oo(e, i, t, -1)) return !0;
      if (0 == r.parent.content.size && (Xi(o, "end") || ot.isSelectable(o)))
        for (let s = r.depth; ; s--) {
          let n = Be(e.doc, r.before(s), r.after(s), c.empty);
          if (n && n.slice.size < n.to - n.from) {
            if (t) {
              let r = e.tr.step(n);
              (r.setSelection(
                Xi(o, "end")
                  ? Qe.findFrom(r.doc.resolve(r.mapping.map(i.pos, -1)), -1)
                  : ot.create(r.doc, i.pos - o.nodeSize),
              ),
                t(r.scrollIntoView()));
            }
            return !0;
      ...
      return (
        !(!o.isAtom || i.depth != r.depth - 1) && (t && t(e.tr.delete(i.pos - o.nodeSize, i.pos).scrollIntoView()), !0)
      );
    },
    (e, t, n) => {
      ...
      return (
        !(!s || !ot.isSelectable(s)) &&
        (t && t(e.tr.setSelection(ot.create(e.doc, o.pos - s.nodeSize)).scrollIntoView()), !0)
      );
    },
  ),
  mo = uo(
    ...
    (e, t, n) => {
      ...
      let o = i.nodeAfter;
      if (oo(e, i, t, 1)) return !0;
      if (0 == r.parent.content.size && (Xi(o, "start") || ot.isSelectable(o))) {
        let n = Be(e.doc, r.before(), r.after(), c.empty);
        if (n && n.slice.size < n.to - n.from) {
          if (t) {
            let r = e.tr.step(n);
            (r.setSelection(
              Xi(o, "start")
                ? Qe.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1)
                : ot.create(r.doc, r.mapping.map(i.pos)),
            ),
              t(r.scrollIntoView()));
          }
          return !0;
      ...
      return (
        !(!o.isAtom || i.depth != r.depth - 1) && (t && t(e.tr.delete(i.pos, i.pos + o.nodeSize).scrollIntoView()), !0)
      );
    },
    (e, t, n) => {
      let { $head: r, empty: i } = e.selection,
      ...
      let s = o && o.nodeAfter;
      return !(!s || !ot.isSelectable(s)) && (t && t(e.tr.setSelection(ot.create(e.doc, o.pos)).scrollIntoView()), !0);
    },
  );
const go = {
    Enter: uo(
      ...
      (e, t) => {
        let n = e.selection,
          { $from: r, $to: i } = n;
        if (n instanceof lt || r.parent.inlineContent || i.parent.inlineContent) return !1;
        let o = no(i.parent.contentMatchAt(i.indexAfter()));
        if (!o || !o.isTextblock) return !1;
        if (t) {
          let n = (!r.parentOffset && i.index() < i.parent.childCount ? r : i).pos,
            s = e.tr.insert(n, o.createAndFill());
          (s.setSelection(rt.create(s.doc, n + 1)), t(s.scrollIntoView()));
        }
        return !0;
      },
      (e, t) => {
        ...
        if (n.depth > 1 && n.after() != n.end(-1)) {
          let r = n.before();
          if (ze(e.doc, r)) return (t && t(e.tr.split(r).scrollIntoView()), !0);
        }
        let r = n.blockRange(),
          i = r && Ee(r);
    ...
    Delete: mo,
    "Mod-Delete": mo,
    "Mod-a": (e, t) => (t && t(e.tr.setSelection(new lt(e.doc))), !0),
  },
  yo = {
    "Ctrl-h": go.Backspace,
    "Alt-Backspace": go["Mod-Backspace"],
    "Ctrl-d": go.Delete,
    "Ctrl-Alt-Backspace": go["Mod-Delete"],
    "Alt-Delete": go["Mod-Delete"],
    "Alt-d": go["Mod-Delete"],
    "Ctrl-a": lo,
    "Ctrl-e": ao,
  };
for (let os in go) yo[os] = go[os];
const wo = (
...
function xo({ rules: e }) {
  let t = new wt({
    ...
    props: {
      handleTextInput: (n, r, i, o) => bo(n, r, i, o, e, t),
      handleDOMEvents: {
        compositionend: (n) => {
          setTimeout(() => {
            let { $cursor: r } = n.state.selection;
            r && bo(n, r.pos, r.pos, "", e, t);
          });
        },
      },
    },
...
function bo(e, t, n, r, i, o) {
  ...
  let s = e.state,
    l = s.doc.resolve(t),
    a = l.parent.textBetween(Math.max(0, l.parentOffset - 500), l.parentOffset, null, "￼") + r;
  for (let h = 0; h < i.length; h++) {
    let c = i[h];
    if (!c.inCodeMark && l.marks().some((e) => e.type.spec.code)) continue;
    if (l.parent.type.spec.code) {
      if (!c.inCode) continue;
    } else if ("only" === c.inCode) continue;
    let d = c.match.exec(a);
    if (!d || d[0].length < r.length) continue;
    let p = t - (d[0].length - r.length);
    if (!c.inCodeMark) {
      let e = !1;
      if (
        (s.doc.nodesBetween(p, l.pos, (t) => {
    ...
    let u = c.handler(s, d, p, n);
    if (u) return (c.undoable && u.setMeta(o, { transform: u, from: t, to: n, text: r }), e.dispatch(u), !0);
  }
  return !1;
}
const So = (e, t) => {
...
function ko(e, t, n = null, r) {
  return new vo(e, (e, i, o, s) => {
    let l = n instanceof Function ? n(i) : n,
      a = e.tr.delete(o, s),
      h = a.doc.resolve(o).blockRange(),
      c = h && Ae(h, t, l);
    if (!c) return null;
    a.wrap(h, c);
    let d = a.doc.resolve(o - 1).nodeBefore;
    return (d && d.type == t && Pe(a.doc, o - 1) && (!r || r(i, d)) && a.join(o - 1), a);
  });
}
function Mo(e, t, n = null) {
  return new vo(e, (e, r, i, o) => {
...
const Co = ["ol", 0],
  ...
  To = {
    ...
    parseDOM: [{ tag: "ol", getAttrs: (e) => ({ order: e.hasAttribute("start") ? +e.getAttribute("start") : 1 }) }],
    toDOM: (e) => (1 == e.attrs.order ? Co : ["ol", { start: e.attrs.order }, 0]),
  },
  Do = { parseDOM: [{ tag: "ul" }], toDOM: () => Oo },
  Eo = { parseDOM: [{ tag: "li" }], toDOM: () => No, defining: !0 };
function Ao(e, t) {
  let n = {};
...
function $o(e, t, n) {
  return e.append({
    ordered_list: Ao(To, { content: "list_item+", group: n }),
    bullet_list: Ao(Do, { content: "list_item+", group: n }),
    list_item: Ao(Eo, { content: t }),
  });
}
    ...
    return (
      !!(function (e, t, n, r = null) {
        ...
        if (t.depth >= 2 && t.$from.node(t.depth - 1).type.compatibleContent(n) && 0 == t.startIndex) {
          ...
          ((s = new O(e, e, t.depth)),
            t.endIndex < t.parent.childCount && (t = new O(t.$from, l.resolve(t.$to.end(t.depth)), t.depth)),
            (o = !0));
        }
        let a = Ae(s, n, r, t);
        if (!a) return !1;
        e &&
          (function (e, t, n, r, o) {
            let s = i.empty;
            for (let c = n.length - 1; c >= 0; c--) s = i.from(n[c].type.create(n[c].attrs, s));
            e.step(new Oe(t.start - (r ? 2 : 0), t.end, t.start, t.end, new c(s, 0, 0), n.length, !0));
            let l = 0;
            for (let i = 0; i < n.length; i++) n[i].type == o && (l = i + 1);
            let a = n.length - l,
              h = t.start + n.length - (r ? 2 : 0),
              d = t.parent;
            for (let i = t.startIndex, c = t.endIndex, p = !0; i < c; i++, p = !1)
              (!p && ze(e.doc, h, a) && (e.split(h, a), (h += 2 * a)), (h += d.child(i).nodeSize));
          })(e, t, a, o, n);
        return !0;
      })(a, l, e, t) && (r && r(a.scrollIntoView()), !0)
    );
  };
}
function Io(e, t) {
  return function (n, r) {
    let { $from: o, $to: s, node: l } = n.selection;
    if ((l && l.isBlock) || o.depth < 2 || !o.sameParent(s)) return !1;
    let a = o.node(-1);
    if (a.type != e) return !1;
    if (0 == o.parent.content.size && o.node(-1).childCount == o.indexAfter(-1)) {
      if (3 == o.depth || o.node(-3).type != e || o.index(-2) != o.node(-2).childCount - 1) return !1;
      if (r) {
        let t = i.empty,
          s = o.index(-1) ? 1 : o.index(-2) ? 2 : 3;
        for (let e = o.depth - s; e >= o.depth - 3; e--) t = i.from(o.node(e).copy(t));
        let l = o.indexAfter(-1) < o.node(-2).childCount ? 1 : o.indexAfter(-2) < o.node(-3).childCount ? 2 : 3;
        t = t.append(i.from(e.createAndFill()));
        let a = o.before(o.depth - (s - 1)),
          h = n.tr.replace(a, o.after(-l), new c(t, 4 - s, 0)),
          d = -1;
        (h.doc.nodesBetween(a, h.doc.content.size, (e, t) => {
          if (d > -1) return !1;
          e.isTextblock && 0 == e.content.size && (d = t + 1);
        }),
          d > -1 && h.setSelection(Qe.near(h.doc.resolve(d))),
          r(h.scrollIntoView()));
      }
      return !0;
    }
    let h = s.pos == o.end() ? a.contentMatchAt(0).defaultType : null,
      d = n.tr.delete(o.pos, s.pos),
      p = h ? [t ? { type: e, attrs: t } : null, { type: h }] : void 0;
    return !!ze(d.doc, o.pos, 2, p) && (r && r(d.split(o.pos, 2, p).scrollIntoView()), !0);
  };
}
function zo(e) {
  return function (t, n) {
    let { $from: r, $to: o } = t.selection,
      s = r.blockRange(o, (t) => t.childCount > 0 && t.firstChild.type == e);
    return (
      !!s &&
      (!n ||
        (r.node(s.depth - 1).type == e
          ? (function (e, t, n, r) {
              let o = e.tr,
                s = r.end,
                l = r.$to.end(r.depth);
              s < l &&
                (o.step(new Oe(s - 1, l, s, l, new c(i.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)),
                (r = new O(o.doc.resolve(r.$from.pos), o.doc.resolve(l), r.depth)));
              const a = Ee(r);
              if (null == a) return !1;
              o.lift(r, a);
              let h = o.doc.resolve(o.mapping.map(s, -1) - 1);
              Pe(o.doc, h.pos) && h.nodeBefore.type == h.nodeAfter.type && o.join(h.pos);
              return (t(o.scrollIntoView()), !0);
            })(t, n, e, s)
          : (function (e, t, n) {
              let r = e.tr,
                o = n.parent;
              for (let i = n.end, c = n.endIndex - 1, m = n.startIndex; c > m; c--)
                ((i -= o.child(c).nodeSize), r.delete(i - 1, i + 1));
              let s = r.doc.resolve(n.start),
                l = s.nodeAfter;
              if (r.mapping.map(n.end) != n.start + s.nodeAfter.nodeSize) return !1;
              let a = 0 == n.startIndex,
                h = n.endIndex == o.childCount,
                d = s.node(-1),
                p = s.index(-1);
              if (!d.canReplace(p + (a ? 0 : 1), p + 1, l.content.append(h ? i.empty : i.from(o)))) return !1;
              let u = s.pos,
                f = u + l.nodeSize;
              return (
                r.step(
                  new Oe(
                    ...
                    f - 1,
                    new c(
                      (a ? i.empty : i.from(o.copy(i.empty))).append(h ? i.empty : i.from(o.copy(i.empty))),
                      a ? 0 : 1,
                      h ? 0 : 1,
                    ),
                    a ? 0 : 1,
...
function Po(e) {
  return function (t, n) {
    ...
    if (n) {
      let r = h.lastChild && h.lastChild.type == a.type,
        o = i.from(r ? e.create() : null),
        l = new c(i.from(e.create(null, i.from(a.type.create(null, o)))), r ? 3 : 1, 0),
        d = s.start,
        p = s.end;
      n(t.tr.step(new Oe(d - (r ? 3 : 1), p, d, p, l, 1, !0)).scrollIntoView());
    }
    return !0;
  };
}
...
((Vo.prototype.append = function (e) {
  return e.length
    ? ((e = Vo.from(e)),
      (!this.length && e) ||
        (e.length < Bo && this.leafAppend(e)) ||
        (this.length < Bo && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
}),
  (Vo.prototype.prepend = function (e) {
    return e.length ? Vo.from(e).append(this) : this;
  }),
  (Vo.prototype.appendInner = function (e) {
    return new Lo(this, e);
  }),
  (Vo.prototype.slice = function (e, t) {
    return (
      void 0 === e && (e = 0),
      void 0 === t && (t = this.length),
      e >= t ? Vo.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
    );
  }),
  (Vo.prototype.get = function (e) {
    if (!(e < 0 || e >= this.length)) return this.getInner(e);
  }),
  (Vo.prototype.forEach = function (e, t, n) {
    (void 0 === t && (t = 0),
      void 0 === n && (n = this.length),
      t <= n ? this.forEachInner(e, t, n, 0) : this.forEachInvertedInner(e, t, n, 0));
  }),
  (Vo.prototype.map = function (e, t, n) {
  ...
  (Vo.from = function (e) {
    return e instanceof Vo ? e : e && e.length ? new Fo(e) : Vo.empty;
  }));
var Fo = (function (e) {
  function t(t) {
  ...
  return (
    ...
    (t.prototype.forEachInner = function (e, t, n, r) {
      for (var i = t; i < n; i++) if (!1 === e(this.values[i], r + i)) return !1;
    }),
    (t.prototype.forEachInvertedInner = function (e, t, n, r) {
      for (var i = t - 1; i >= n; i--) if (!1 === e(this.values[i], r + i)) return !1;
    }),
    (t.prototype.leafAppend = function (e) {
      if (this.length + e.length <= Bo) return new t(this.values.concat(e.flatten()));
    }),
    (t.prototype.leafPrepend = function (e) {
      if (this.length + e.length <= Bo) return new t(e.flatten().concat(this.values));
    }),
  ...
  return (
    ...
    (t.prototype.forEachInner = function (e, t, n, r) {
      ...
      return (
        ...
        !(n > i && !1 === this.right.forEachInner(e, Math.max(t - i, 0), Math.min(this.length, n) - i, r + i)) &&
        void 0
      );
    }),
    (t.prototype.forEachInvertedInner = function (e, t, n, r) {
      var i = this.left.length;
      return (
        !(t > i && !1 === this.right.forEachInvertedInner(e, t - i, Math.max(n, i) - i, r + i)) &&
        !(n < i && !1 === this.left.forEachInvertedInner(e, Math.min(t, i), n, r)) &&
        void 0
      );
    }),
...
class Wo {
  ...
  popEvent(e, t) {
    ...
    t && ((n = this.remapping(i, this.items.length)), (r = n.maps.length));
    let o,
      s,
      l = e.tr,
      a = [],
    ...
    return (
      this.items.forEach(
        (e, t) => {
          if (!e.step) return (n || ((n = this.remapping(i, t + 1)), (r = n.maps.length)), r--, void h.push(e));
          if (n) {
            h.push(new Jo(e.map));
            let t,
            ...
            (i &&
              l.maybeStep(i).doc &&
              ((t = l.mapping.maps[l.mapping.maps.length - 1]), a.push(new Jo(t, void 0, void 0, a.length + h.length))),
              r--,
              t && n.appendMap(t, r));
          } else l.maybeStep(e.step);
          return e.selection
            ? ((o = n ? e.selection.map(n.slice(r)) : e.selection),
              (s = new Wo(this.items.slice(0, i).append(h.reverse().concat(a)), this.eventCount - 1)),
              !1)
            : void 0;
        },
        this.items.length,
  ...
  addTransform(e, t, n, r) {
    ...
    for (let h = 0; h < e.steps.length; h++) {
      let n,
        a = e.steps[h].invert(e.docs[h]),
        c = new Jo(e.mapping.maps[h], a, t);
      ((n = l && l.merge(c)) && ((c = n), h ? i.pop() : (s = s.slice(0, s.length - 1))),
        i.push(c),
        t && (o++, (t = void 0)),
        r || (l = c));
    }
  ...
  remapping(e, t) {
    ...
    return (
      this.items.forEach(
        (t, r) => {
          let i = null != t.mirrorOffset && r - t.mirrorOffset >= e ? n.maps.length - t.mirrorOffset : void 0;
          n.appendMap(t.map, i);
        },
        e,
        t,
  ...
  addMaps(e) {
    return 0 == this.eventCount ? this : new Wo(this.items.append(e.map((e) => new Jo(e))), this.eventCount);
  }
  rebased(e, t) {
    ...
    this.items.forEach((t) => {
      ...
      if (t.step) {
        ...
        (h && s++, n.push(new Jo(a, o, h)));
      } else n.push(new Jo(a));
    }, r);
    let a = [];
    for (let d = t; d < o; d++) a.push(new Jo(i.maps[d]));
  ...
  compress(e = this.items.length) {
    ...
    return (
      ...
      new Wo(Vo.from(r.reverse()), i)
    );
  }
}
Wo.empty = new Wo(Vo.empty, 0);
class Jo {
  constructor(e, t, n, r) {
  ...
  merge(e) {
    if (this.step && e.step && !e.selection) {
      ...
      if (t) return new Jo(t.getMap().invert(), t, this.selection);
    }
  }
}
class qo {
...
function _o(e) {
  let t = [];
  for (let n = e.length - 1; n >= 0 && 0 == t.length; n--) e[n].forEach((e, n, r, i) => t.push(r, i));
  return t;
}
function Ko(e, t) {
  if (!e) return null;
...
const Go = new bt("history"),
  Zo = new bt("closeHistory");
function Xo(e = {}) {
  return (
    ...
    new wt({
      key: Go,
      state: {
        init: () => new qo(Wo.empty, Wo.empty, null, 0, -1),
        apply: (t, n, r) =>
          (function (e, t, n, r) {
            let i,
              o = n.getMeta(Go);
            if (o) return o.historyState;
            n.getMeta(Zo) && (e = new qo(e.done, e.undone, null, 0, -1));
            let s = n.getMeta("appendedTransaction");
            if (0 == n.steps.length) return e;
            if (s && s.getMeta(Go))
              return s.getMeta(Go).redo
                ? new qo(
                    e.done.addTransform(n, void 0, r, Uo(t)),
                    e.undone,
                    _o(n.mapping.maps),
                    e.prevTime,
                    e.prevComposition,
                  ...
                  );
            {
              let i = n.getMeta("composition"),
                ...
                l = s ? Ko(e.prevRanges, n.mapping) : _o(n.mapping.maps);
              return new qo(
                e.done.addTransform(n, o ? t.selection.getBookmark() : void 0, r, Uo(t)),
                Wo.empty,
                l,
                n.time,
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let n = t.inputType,
              r = "historyUndo" == n ? es : "historyRedo" == n ? ts : null;
            return !(!r || !e.editable) && (t.preventDefault(), r(e.state, e.dispatch));
          },
        },
      },
    })
  ...
  return (n, r) => {
    ...
    if (r) {
      let o = (function (e, t, n) {
        let r = Uo(t),
          i = Go.get(t).spec.config,
          o = (n ? e.undone : e.done).popEvent(t, r);
        if (!o) return null;
        let s = o.selection.resolve(o.transform.doc),
          l = (n ? e.done : e.undone).addTransform(o.transform, t.selection.getBookmark(), i, r),
          a = new qo(n ? l : o.remaining, n ? o.remaining : l, null, 0, -1);
        return o.transform.setSelection(s).setMeta(Go, { redo: n, historyState: a });
      })(i, n, e);
...
var ls = "undefined" != typeof window;
function as(e, t) {
...
var hs = {},
  ...
  ps = e.extend({
    data: function () {
      return { transports: hs, targets: cs, sources: ds, trackInstances: ls };
    },
    methods: {
      open: function (t) {
        if (ls) {
          ...
          if (n && r && i) {
            var l,
              a = {
                to: n,
                from: r,
                passengers: ((l = i), Array.isArray(l) || "object" === is(l) ? Object.freeze(l) : l),
                order: s,
              };
            -1 === Object.keys(this.transports).indexOf(n) && e.set(this.transports, n, []);
            var h,
              c = this.$_getTransportIndex(a),
              d = this.transports[n].slice(0);
            (-1 === c ? d.push(a) : (d[c] = a),
              (this.transports[n] =
                ((h = function (e, t) {
      ...
      registerTarget: function (e, t, n) {
        ls &&
          (this.trackInstances &&
            !n &&
            this.targets[e] &&
            console.warn("[portal-vue]: Target ".concat(e, " already exists")),
      ...
      registerSource: function (e, t, n) {
        ls &&
          (this.trackInstances &&
            !n &&
            this.sources[e] &&
            console.warn("[portal-vue]: source ".concat(e, " already exists")),
  ...
  ms = e.extend({
    ...
    beforeDestroy: function () {
      (us.unregisterSource(this.name), this.clear());
    },
    watch: {
      to: function (e, t) {
    ...
    methods: {
      ...
      sendUpdate: function () {
        ...
        if (e) {
          var t = { from: this.name, to: this.to, passengers: ss(e), order: this.order };
          us.open(t);
        } else this.clear();
      },
    },
    render: function (e) {
      ...
      return t && this.disabled
        ...
        : this.slim
          ? e()
          : e(n, { class: { "v-portal": !0 }, style: { display: "none" }, key: "v-portal-placeholder" });
    },
  }),
  gs = e.extend({
    name: "portalTarget",
    ...
    data: function () {
      return { transports: us.transports, firstRender: !0 };
    },
    created: function () {
      var e = this;
      this.$nextTick(function () {
        us.registerTarget(e.name, e);
      });
    },
    watch: {
      ...
      name: function (e, t) {
        (us.unregisterTarget(t), us.registerTarget(e, this));
      },
    },
    mounted: function () {
      var e = this;
    ...
    render: function (e) {
      ...
      return t
        ...
        : this.slim && !r
          ...
          : e(
              r,
              { props: { tag: this.transition && this.tag ? this.tag : void 0 }, class: { "vue-portal-target": !0 } },
              n,
            );
    },
  }),
  ys = 0,
  ws = ["disabled", "name", "order", "slim", "slotProps", "tag", "to"],
  vs = ["multiple", "transition"],
  xs = e.extend({
    name: "MountingPortal",
    inheritAttrs: !1,
    props: {
        ...
        if (e) {
          ...
          if (us.targets[t.name])
            t.bail
              ...
              : (this.portalTarget = us.targets[t.name]);
          else {
            var n = t.append;
            if (n) {
            ...
            var o = as(this.$props, vs);
            ((o.slim = this.targetSlim),
              (o.tag = this.targetTag),
              (o.slotProps = this.targetSlotProps),
              (o.name = this.to),
              (this.portalTarget = new gs({ el: e, parent: this.$parent || this, propsData: o })));
          }
...
var bs = {
    install: function (e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      (e.component(t.portalName || "Portal", ms),
        e.component(t.portalTargetName || "PortalTarget", gs),
        e.component(t.MountingPortalName || "MountingPortal", xs));
    },
  },
  Ss = new Map();
function ks(e) {
...
"undefined" == typeof window
  ...
  : (((Cs = function (e, t) {
      return (
        e &&
          Array.prototype.forEach.call(e.length ? e : [e], function (e) {
            return (function (e) {
              if (e && e.nodeName && "TEXTAREA" === e.nodeName && !Ss.has(e)) {
                var t,
                  n = null,
                  ...
                  i =
                    ((t = e.value),
                    function () {
                      (s({ testForHeightReduction: "" === t || !e.value.startsWith(t), restoreTextAlign: null }),
                        (t = e.value));
                    }),
                  o = function (t) {
                ...
                (e.addEventListener("autosize:destroy", o),
                  ...
                  Ss.set(e, { destroy: o, update: l }),
                  l());
              }
              function s(t) {
                var i,
                  o,
                  l = t.restoreTextAlign,
                  a = void 0 === l ? null : l,
                  h = t.testForHeightReduction,
                  c = void 0 === h || h,
                  d = r.overflowY;
                if (
                  0 !== e.scrollHeight &&
                  ...
                  (o =
                    "content-box" === r.boxSizing
                      ? e.scrollHeight - (parseFloat(r.paddingTop) + parseFloat(r.paddingBottom))
                      : e.scrollHeight + parseFloat(r.borderTopWidth) + parseFloat(r.borderBottomWidth)),
                  "none" !== r.maxHeight && o > parseFloat(r.maxHeight)
                    ? ("hidden" === r.overflowY && (e.style.overflow = "scroll"), (o = parseFloat(r.maxHeight)))
                    : "hidden" !== r.overflowY && (e.style.overflow = "hidden"),
                  (e.style.height = o + "px"),
                  a && (e.style.textAlign = a),
                  i && i(),
                  n !== o && (e.dispatchEvent(new Event("autosize:resized", { bubbles: !0 })), (n = o)),
                  d !== r.overflow && !a)
                ) {
                  var p = r.textAlign;
                  ("hidden" === r.overflow && (e.style.textAlign = "start" === p ? "end" : "start"),
                    s({ restoreTextAlign: p, testForHeightReduction: !0 }));
                }
              }
              function l() {
      ...
      return (e && Array.prototype.forEach.call(e.length ? e : [e], ks), e);
    }),
    (Cs.update = function (e) {
      return (e && Array.prototype.forEach.call(e.length ? e : [e], Ms), e);
    }));
var Os = Cs;
function Ns(e) {
    ...
    (Ds.exports = (function () {
      var e = 1e3,
        ...
        w = {
          ...
          p: function (e) {
            return (
              { M: h, y: d, w: a, d: l, D: p, h: s, m: o, s: i, ms: r, Q: c }[e] ||
              String(e || "")
                .toLowerCase()
                .replace(/s$/, "")
            );
      ...
      var O = (function () {
          function g(e) {
            ((this.$L = k(e.locale, null, !0)), this.parse(e), (this.$x = this.$x || e.x || {}), (this[b] = !0));
          }
          var y = g.prototype;
          return (
            (y.parse = function (e) {
            ...
            (y.startOf = function (e, t) {
              ...
              switch (c) {
                ...
                case h:
                  return r ? u(1, g) : u(0, g + 1);
                case a:
                  var v = this.$locale().weekStart || 0,
                    x = (m < v ? m + 7 : m) - v;
                  return u(r ? y - x : y + (6 - x), g);
                case l:
                case p:
                  return f(w + "Hours", 0);
                case s:
            ...
            (y.$set = function (e, t) {
              var n,
                ...
                (n[r] = c + "Milliseconds"),
                n)[a],
                f = a === l ? this.$D + (t - this.$W) : t;
              if (a === h || a === d) {
                var m = this.clone().set(p, 1);
                (m.$d[u](f), m.init(), (this.$d = m.set(p, Math.min(this.$D, m.daysInMonth())).$d));
              } else u && this.$d[u](f);
            ...
            (y.add = function (r, c) {
              ...
              var f = C.p(c),
                m = function (e) {
                  var t = M(u);
                  return C.w(t.date(t.date() + Math.round(e * r)), u);
                };
              if (f === h) return this.set(h, this.$M + r);
              if (f === d) return this.set(d, this.$y + r);
              if (f === l) return m(1);
              if (f === a) return m(7);
              var g = ((p = {}), (p[o] = t), (p[s] = n), (p[i] = e), p)[f] || 1,
                  ...
                  (function (e) {
                    switch (e) {
                      ...
                      case "d":
                        return String(t.$W);
                      case "dd":
                        return d(n.weekdaysMin, t.$W, a, 2);
                      case "ddd":
                        return d(n.weekdaysShort, t.$W, a, 3);
                      case "dddd":
                        return a[t.$W];
                      case "H":
                        return String(o);
      ...
      function u(n) {
        ...
        for (
          ...
          var h = o[a],
            ...
            d = c && c[0],
            u = c && c[1];
          o[a] = u ? { regex: d, parser: u } : h.replace(/^\[|\]$/g, "");
        }
        return function (e) {
        ...
        r.parse = function (e) {
          ...
          if ("string" == typeof l) {
            ...
            (h && (d = o[2]),
              ...
              (this.$d = (function (e, t, n, r) {
                try {
                  ...
                  var v,
                    ...
                    k = d || 0;
                  return p
                    ? new Date(Date.UTC(y, w, g, x, b, S, k + 60 * p.offset * 1e3))
                    : n
                      ? new Date(Date.UTC(y, w, g, x, b, S, k))
                      : ((v = new Date(y, w, g, x, b, S, k)), f && (v = r(v).week(f).toDate()), v);
                } catch (M) {
                  return new Date("");
                }
              })(t, l, r, n)),
              ...
              c && t != this.format(l) && (this.$d = new Date("")),
              (s = {}));
          } else if (l instanceof Array)
            for (var p = l.length, f = 1; f <= p; f += 1) {
              o[1] = l[f - 1];
